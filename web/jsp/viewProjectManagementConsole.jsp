...
<html>
    ...
    <div class="content content--manageProject">
        <div class="content__inner">
            <div class="editProjectLink__header">
                ...
                <jsp:include page="/includes/project/project_info_reskin.jsp" >
                    <jsp:param name="titleAction" value="- Manage Project"/>
                </jsp:include>
            </div>
            <div class="divider"></div>
            <div class="manageProject">
                <div class="manageProject__sectionHeader">
                    <div class="manageProject__title">
                        project management
                    </div>
                </div>
                <div class="manageProject__sectionBody">
                    <div id="mainContent">
                        <div id="tabcontentcontainer">
                                ...
                                <div class="projectDetails__tabs">
                                    <div class='projectDetails__tab projectDetails__tab--active'>
                                        <a href="javascript:void(0)"
                                            onClick="return activateTab('sc1', this)">
                                            <or:text key="manageProject.TimelineResources.title"/>
                                        </a>
                                    </div>
                                    <c:if test="${((project.projectCategory.id == 1) || (project.projectCategory.id == 2))}">
                                        ...
                                        <div class='projectDetails__tab'>
                                            <a href="javascript:void(0)"
                                                onClick="return activateTab('sc2', this)">
                                                <or:text key="manageProject.Distributions.title"/>
                                            </a>
                                        </div>
                                    </c:if>
                                    <c:if test="${reviewFeedbacksExist || reviewFeedbackAllowed}">
                                        <div class='projectDetails__tab'>
                                            <a href="javascript:void(0)"
                                                onClick="return activateTab('sc3', this)">
                                                <or:text key="manageProject.ReviewPerformance.title"/>
                                            </a>
                                        </div>
                                    </c:if>
                                    <div class='projectDetails__tab'>
                                        <a href="javascript:void(0)"
                                            onClick="return activateTab('sc4', this)">
                                            <or:text key="manageProject.ReviewPayments.title"/>
                                        </a>
                                    </div>
                                </div>
                                <table class="manageProjectTable" cellpadding="0" width="100%" style="border-collapse: collapse;">
                                <tr class="light">
                                <td>
                                    <c:if test="${((empty param.activeTabIdx) || (param.activeTabIdx == 1))}">
                                        ...
                                        <c:if test="${orfn:isErrorsPresent(pageContext.request)}">
                                            <table class="table__error" cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                    <td colspan="2">
                                    ...
                                    <s:form action="ManageProject" namespace="/actions" class="manageProjectForm">
                                        <input type="hidden" name="pid" value="${project.id}" />

                                        <div id="tabNewLinks">
                                            <%-- Extend Registration Phase area --%>
                                            <table class="extendRegistrationTable" id="reg_phase_tbl" cellpadding="0" width="100%"
                                                style="border-collapse: collapse;">
                                                <thead class="extendRegistration__header">
                                                    <tr>
                                                ...
                                                <tbody class="extendRegistration__body">
                                                    <tr class="light">
                                                        <td class="label">
                                                    ...
                                                    <tr class="light">
                                                        ...
                                                        <td class="input">
                                                            <input type="text" class="edit__inputBoxDuration" name="registration_phase_extension"
                                                ...
                                                <table class="extendSubTable" id="submission_phase_tbl" cellpadding="0" width="100%"
                                                    style="border-collapse: collapse;">
                                                    <thead class="extendSubTable__header">
                                                        <tr>
                                                            <th colspan="2">
                                                    ...
                                                    <tbody class="extendSubTable__body">
                                                        <tr class="light">
                                                            <td class="label">
                                                        ...
                                                        <tr class="light">
                                                            ...
                                                            <td class="input">
                                                                <input type="text" class="edit__inputBoxDuration" name="submission_phase_extension"
                                            ...
                                            <%-- Add Resources area --%>
                                            <table class="addResourcesTable" id="resources_tbl" cellpadding="0" width="100%"
                                                style="border-collapse: collapse;">
                                                <thead class="addResourcesTable__title">
                                                    <th class="title" colspan="5"><or:text key="manageProject.Resources.title" /></th>
                                                </thead>
                                                <tr class="addResourcesTable__header">
                                                    <td class="title"><or:text key="manageProject.Resources.Role"/></td>
                                                    <td class="title"><or:text key="manageProject.Resources.Handles"/></td>
                                                </tr>
                                                <tbody class="addResourcesTable__body"
                                                    <c:forEach items="${requestScope.availableRoles}" var="role" varStatus="index">
                                                        <tr class="${(index.index % 2 == 0) ? 'light' : 'dark'}">
                                                            ...
                                                            <td class="label input">
                                                                <input type="text" class="edit__inputBoxDuration addResInput" name="resource_handles[${index.index}]"
                            ...
                            <c:if test="${((project.projectCategory.id == 1) || (project.projectCategory.id == 2))}">
                                <div id="sc2" style='display:${(param.activeTabIdx == 2) ? "block" : "none"};'>
                                    <div class="projectDetails__tabs">
                                        <div class="projectDetails__tab">
                                            <a href="javascript:void(0)" onClick="return activateTab('sc1', this)">
                                                <or:text key="manageProject.TimelineResources.title" />
                                            </a>
                                        </div>
                                        <%-- Only show the tab for design and development --%>
                                        <div class="projectDetails__tab projectDetails__tab--active">
                                            <a href="javascript:void(0)" onClick="return activateTab('sc2', this)">
                                                <or:text key="manageProject.Distributions.title" />
                                            </a>
                                        </div>
                                        <c:if test="${reviewFeedbacksExist || reviewFeedbackAllowed}">
                                            <div class="projectDetails__tab">
                                                <a href="javascript:void(0)" onClick="return activateTab('sc3', this)">
                                                    <or:text key="manageProject.ReviewPerformance.title" />
                                                </a>
                                            </div>
                                        </c:if>
                                        <div class="projectDetails__tab">
                                            <a href="javascript:void(0)" onClick="return activateTab('sc4', this)">
                                                <or:text key="manageProject.ReviewPayments.title" />
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <tr class="light">
                                        <td>
                                            ...
                                            <s:form action="SaveReviewPayments?activeTabIdx=4" namespace="/actions">
                                                ...
                                                <div id="tabNewLinks">
                                                    <table class="reviewPaymentTable" id="review_payments_tbl" cellpadding="0" width="100%"
                                                        style="border-collapse: collapse;">
                                                        <thead class="reviewPaymentTable__header">
                                                            <tr>
                                                                <th><or:text key="manageProject.ReviewPayments.ResourceRole"/></th>
                                                                <th width=23%><or:text key="manageProject.ReviewPayments.default"/> *</th>
                                                                <th width=23%><or:text key="manageProject.ReviewPayments.FixedAmount"/></th>
                                                                <th width=25%><or:text key="manageProject.ReviewPayments.percent"/></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody class="reviewPaymentTable__body">
                                                            ...
                                                            <tr <c:if test="${vs.index % 2 eq 0}">class="light"</c:if> <c:if test="${vs.index % 2 eq 1}">class="dark"</c:if> >
                                                                ...
                                                                <td class="value" nowrap="nowrap">
                                                                    <div class="custom-radio">
                                                                        ...
                                                                        <label class="fixedAmt" for="resource_payments_radio_fixed[${reviewPaymentsIdx}]"></label>
                                                                    </div>
                                                                    <label for="resource_payments_radio_fixed[${reviewPaymentsIdx}]">${"$"}</label>
                                                                    <c:if test="${isSubmitReturn}">
                                                                        <input type="text" name="resource_payments_fixed_amount[${reviewPaymentsIdx}]" class="edit__inputBoxDuration" value="<or:fieldvalue field='resource_payments_fixed_amount[${reviewPaymentsIdx}]' />" />
                                                                    </c:if>
                                                                    <c:if test="${not isSubmitReturn}">
                                                                        <input type="text" name="resource_payments_fixed_amount[${reviewPaymentsIdx}]" class="edit__inputBoxDuration" value="${reviewPaymentsFixed[reviewPaymentsIdx]}" />
                                                                    </c:if>
                                                                ...
                                                                <td class="value" nowrap="nowrap">
                                                                    <div class="custom-radio">
                                                                        ...
                                                                        <label class="percentage" for="resource_payments_radio_percentage[${reviewPaymentsIdx}]"></label>
                                                                    </div>
                                                                    <c:if test="${isSubmitReturn}">
                                                                        <input type="text" name="resource_payments_percent_amount[${reviewPaymentsIdx}]" class="edit__inputBoxDuration" value="<or:fieldvalue field='resource_payments_percent_amount[${reviewPaymentsIdx}]' />" />
                                                                    </c:if>
                                                                    <c:if test="${not isSubmitReturn}">
                                                                        <input type="text" name="resource_payments_percent_amount[${reviewPaymentsIdx}]" class="edit__inputBoxDuration" value="${reviewPaymentsPercentage[reviewPaymentsIdx]}" />
                                                                    </c:if>
