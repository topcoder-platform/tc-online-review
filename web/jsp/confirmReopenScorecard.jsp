            ...
            <div id="mainMiddleContent">
                <div style="position: relative; width: 100%;">
                    ...
                    <table class="scorecard" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                        <tr>
                            <td class="title"><bean:message key="confirmReopenScorecard.box.title" /></td>
                        </tr>
                        <tr class="light">
                            <td class="valueC">
                                <br />
                                <bean:message key="confirmReopenScorecard.question" /><br /><br />
                            </td>
                        </tr>
                        <tr>
                    ...
                    <div align="right">
                        <html:link page="/actions/ReopenScorecard.do?method=reopenScorecard&rid=${review.id}&reopen=y"><html:img srcKey="confirmReopenScorecard.btnConfirm.img" altKey="confirmReopenScorecard.btnConfirm.alt" border="0" /></html:link>&#160;
