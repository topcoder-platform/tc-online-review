...
/**
 * This class is the struts action class which is used to view the screening review.
 * <p>
 ...
 * @version 2.0
 */
public class ViewScreeningAction extends BaseViewOrExportGenericReviewAction {

    /**
     * Represents the serial version id.
     */
    private static final long serialVersionUID = 4206352684253196223L;
    ...
    public String execute() throws BaseException {
        ...
        return viewOrExportGenericReview(request, response, "Screening", false);
    }
}
