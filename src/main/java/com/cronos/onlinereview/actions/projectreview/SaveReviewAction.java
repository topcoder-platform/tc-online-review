...
/**
 * This class is the struts action class which is used to save the review.
 * <p>
 ...
 * @version 2.0
 */
public class SaveReviewAction extends BaseProjectReviewAction {

    /**
     * Represents the serial version id.
     */
    private static final long serialVersionUID = 2202846702734942907L;
    ...
    public String execute()
        ...
        return saveGenericReview(getModel(), request, "Review");
    }
}
