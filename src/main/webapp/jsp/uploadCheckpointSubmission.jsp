        ...
        <jsp:include page="/includes/project/project_tabs.jsp" />
            ...
            <div id="mainMiddleContent">
                <div style="position: relative; width: 100%;">
                    ...
                    <s:form action="UploadCheckpointSubmission" method="POST" enctype="multipart/form-data" namespace="/actions">
                        ...
                        <table class="scorecard" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                            <tr>
                                <td class="title">
                                    <or:text key="uploadCheckpointSubmission.box.UploadCheckpointSubmission"/>
                                </td>
                            </tr>
                            <tr class="light">
                                <td class="value">
                                    <or:text key="uploadCheckpointSubmission.HelpLine1" /><br /><br />
                                    <or:text key="uploadCheckpointSubmission.UploadCheckpointSubmission" />
                                    ...
                                    <or:text key="uploadCheckpointSubmission.HelpLine2" />
                                    <or:text key="uploadCheckpointSubmission.HelpLine3" />

                                    <a href="http://<%=ApplicationServer.SERVER_NAME%>/wiki/display/tc/Documentation+and+Submission+Guidelines"><or:text key="uploadCheckpointSubmission.SampleSubmissionAndDocs" /></a>

                                    <or:text key="uploadCheckpointSubmission.HelpLine4" />
                                </td>
                            </tr>
                            <tr>
