...
/**
 * This class is the struts action class which is used to create the checkpoint screening.
 * <p>
 ...
 * @version 2.0
 */
public class CreateCheckpointScreeningAction extends BaseProjectReviewAction {

    /**
     * Represents the serial version id.
     */
    private static final long serialVersionUID = -20811831001653769L;
    ...
    public String execute() throws BaseException {
        ...
        return createGenericReview(request, "Checkpoint Screening");
    }
}
