    ...
    <tr valign="top">
        ...
        <td width="100%">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
                ...
                <tr><td class="normal">
                    <img src="/images/headRegNewAcct.gif" alt="Register New Account" width="545" height="35" border="0"/>
                </td></tr>
                <% if (activated) { %>
            ...
            <table width="100%" cellpadding="0" cellspacing="6" align="center" border="0">
                <tr valign="top">
                    <td class="normal">
                        ...
                        <% } %>
                        <p>If you have any questions about your TopCoder Software Account, call us at 866.TOP.CODE
                            (866.867.2633).</p>
                    </td>
                </tr>
