...
<!-- Middle Column begins -->
		<td width="100%">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
				<tr valign="top">
					<td class="normal">
					Your submission has been uploaded and received by TopCoder Software.  You will be receiving a confirmation email to the email address registered with your account.  If you do not receive the email please contact <a class="statText" href="mailto:service@topcodersoftware.com">service@topcodersoftware.com</a>.
					</td>
				</tr>
			</table>
