...
<div align="center">
    ...
    <div style="width: 700px; background: transparent;">
        ...
        <jsp:include page="nav.jsp">
            <jsp:param name="node" value="page8"/>
        </jsp:include>

        <div id="slide">
            <a href="/tcs?module=Static&amp;d1=tour&amp;d2=page9" onfocus="this.blur();"><img src="/i/tour/page8.jpg" alt="" /></a>
        </div>
        ...
        <div align="center">
            <div style="width: 60px; height: 28px; margin: 10px;">
                <div style="float: left;">
                    <a href="/tcs?module=Static&amp;d1=tour&amp;d2=page7" onfocus="this.blur();"><img src="/i/tour/prev.png" alt="Previous page" /></a>
                </div>
                <div style="float: right;">
                    <a href="/tcs?module=Static&amp;d1=tour&amp;d2=page9" onfocus="this.blur();"><img src="/i/tour/next.png" alt="Next page" /></a>
                </div>
            </div>
        </div>
