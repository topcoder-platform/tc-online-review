...
<div align="center">
    ...
    <div style="width: 700px; background: transparent;">
        ...
        <div id="slide">
            <a href="/tcs?module=Static&amp;d1=tour&amp;d2=page5" onfocus="this.blur();"><img src="/i/tour/page4.jpg" alt="" /></a>
        </div>
        ...
        <div align="center">
            <div style="width: 60px; height: 28px; margin: 10px;">
                <div style="float: left;">
                    <a href="/tcs?module=Static&amp;d1=tour&amp;d2=page3" onfocus="this.blur();"><img src="/i/tour/prev.png" alt="Previous page" /></a>
                </div>
                <div style="float: right;">
                    <a href="/tcs?module=Static&amp;d1=tour&amp;d2=page5" onfocus="this.blur();"><img src="/i/tour/next.png" alt="Next page" /></a>
                </div>
            </div>
        </div>
