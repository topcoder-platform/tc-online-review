...
<div align="center">
    ...
    <div style="width: 700px; background: transparent;">
        ...
        <jsp:include page="nav.jsp">
            <jsp:param name="node" value="page7"/>
        </jsp:include>

        <div id="slide">
            <a href="/tcs?module=Static&amp;d1=tour&amp;d2=page8" onfocus="this.blur();"><img src="/i/tour/page7.jpg" alt="" /></a>
        </div>

        <%--<h2 align="center">
            Assembly & Testing Competitions.
        </h2>--%>

        <div align="center">
            <div style="width: 60px; height: 28px; margin: 10px;">
                <div style="float: left;">
                    <a href="/tcs?module=Static&amp;d1=tour&amp;d2=page6" onfocus="this.blur();"><img src="/i/tour/prev.png" alt="Previous page" /></a>
                </div>
                <div style="float: right;">
                    <a href="/tcs?module=Static&amp;d1=tour&amp;d2=page8" onfocus="this.blur();"><img src="/i/tour/next.png" alt="Next page" /></a>
                </div>
            </div>
        </div>
