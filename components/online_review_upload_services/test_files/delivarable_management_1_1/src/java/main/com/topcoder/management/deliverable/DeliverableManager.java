...
/**
 * <p> The DeliverableManager interface provides the ability to persist, retrieve and search for persisted deliverable
 * modeling objects. This interface provides a higher level of interaction than the DeliverablePersistence interface.
 * This interface simply provides two methods to search a persistence store for Deliverables. </p>
 *
