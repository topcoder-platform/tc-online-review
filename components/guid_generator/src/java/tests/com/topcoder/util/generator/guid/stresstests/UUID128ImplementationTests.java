/*-
 * ----------------------------------------------------------------------------
 * FileName: UUID128ImplementationTests.java
 * Version: 1.0
 * Date: Aug 31, 2004
 *
...
/**
 * <p>
 * This class contains the unit tests for UUID128Implementation.</p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 * <p>Copyright (c) 2004, TopCoder, Inc. All rights reserved</p>
...
public class UUID128ImplementationTests extends TestCase {
     ...
     * specifications.</p>
     */
    private String STRING_UUID = "29070502-0207-0529-3607-311243073134";

    /**
     * <p>
     * Represents the instance of the UUID to be used for testing.</p>
     */
    private UUID128Implementation uuid = null;
    /*------------------------------------------------------------------------*/
     ...
     */
    public UUID128ImplementationTests(String name) {
        super(name);
    } // end UUID128ImplementationTests()
     ...
     */
    public void setUp() {
        this.uuid = new UUID128Implementation(BYTES);
    } // end setUp()
    /*------------------------------------------------------------------------*/
    ...
    public void testToStringMultipleCount() {
        ...
        System.out.println("UUID128Implementation.toString(): " + (s - a));
    ...
    public void testToByteArrayMultipleCount() {
        ...
        long s = System.currentTimeMillis();
        System.out.println("UUID128Implementation.toByteArray(): " + (s - a));
