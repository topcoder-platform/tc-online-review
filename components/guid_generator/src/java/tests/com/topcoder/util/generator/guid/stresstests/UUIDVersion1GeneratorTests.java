/*-
 * ----------------------------------------------------------------------------
 * FileName: UUIDVersion1GeneratorTests.java
 * Version: 1.0
 * Date: Aug 31, 2004
 *
...
/**
 * <p>
 * This class contains the unit tests for UUIDVersion1Generator.</p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 * <p>Copyright (c) 2004, TopCoder, Inc. All rights reserved</p>
...
public class UUIDVersion1GeneratorTests extends TestCase {
    ...
    /**
     * <p>
     * Represents the instance of UUIDVersion1Generator to be used for testing.</p>
     */
    private UUIDVersion1Generator generator = null;
    /*------------------------------------------------------------------------*/
     ...
     */
    public UUIDVersion1GeneratorTests(String name) {
        super(name);
    } // end UUIDVersion1GeneratorTests()
     ...
     */
    public void setUp() {
        this.generator = new UUIDVersion1Generator();
    } // end setUp()
    /*------------------------------------------------------------------------*/
    ...
    public void testGetNextUUIDMultipleCount() {
        ...
        System.out.println("UUIDVersion1Generator.getNextUUID(): " + (s - a));
