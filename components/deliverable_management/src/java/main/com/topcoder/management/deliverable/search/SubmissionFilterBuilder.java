...
public class SubmissionFilterBuilder {
    ...
    /**
     * The name of the field under which SearchBuilder Filters can be built in order to filter on
     * the project phase the submission is associated with.
     * @since 1.2.2
     */
    ...
    /**
     * Creates a filter that selects submissions related to the project phase with the given id.
     *
     * @return A filter for selecting submissions related to the given project phase
    ...
    public static Filter createSubmissionStatusIdFilter(long submissionStatusId) {
        ...
        return new EqualToFilter(SUBMISSION_STATUS_ID_FIELD_NAME, submissionStatusId);
    }
    ...
    public static Filter createSubmissionTypeIdFilter(long submissionTypeId) {
        ...
        return new EqualToFilter(SUBMISSION_TYPE_ID_FIELD_NAME, submissionTypeId);
    }
}
