...
public class DeliverableFilterBuilder {
    ...
    public static Filter createDeliverableIdFilter(long deliverableId) {
        ...
        return new EqualToFilter(DELIVERABLE_ID_FIELD_NAME, deliverableId);
    }
    ...
    public static Filter createRequiredFilter(boolean isRequired) {
        ...
        if (isRequired) {
            return new NotFilter(new EqualToFilter(REQUIRED_FIELD_NAME, 0));
        }

        return new EqualToFilter(REQUIRED_FIELD_NAME, 0);
    }
