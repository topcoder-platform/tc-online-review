 ...
 * </p>
 *
 * @author aubergineanode, singlewood, sparemax, gjw99
 * @version 1.2.4
 */
public class Submission extends AuditedDeliverableStructure {
    ...
    /**
     * Represents the Thurgood Job Id.
     * @since 1.2.4
     */
    private String thurgoodJobId = null;
	...
	/**
	 * Getter of thurgoodJobId field.
	 * @return the Thurgood Job Id.
	 * @since 1.2.4
	 */
	public String getThurgoodJobId() {
		return thurgoodJobId;
	}

	/**
	 * Setter of thurgoodJobId field.
	 * @param thurgoodJobId the Thurgood Job Id to set
	 * @since 1.2.4
	 */
	public void setThurgoodJobId(String thurgoodJobId) {
		this.thurgoodJobId = thurgoodJobId;
	}
}
