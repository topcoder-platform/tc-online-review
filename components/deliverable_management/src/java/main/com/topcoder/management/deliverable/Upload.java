...
public class Upload extends AuditedDeliverableStructure {
    ...
    /**
     * The value that the project phase field will have (and that the getProjectPhase method will return) when
     * the project phase field has not been through the setProjectPhase method.
     */
    public static final long UNSET_PROJECT_PHASE = -1;
    ...
    /**
     * The project phase that the upload is associated with. This field can be greater than 0 or
     * UNSET_PROJECT_PHASE and is mutable. The default value is UNSET_PROJECT_PHASE,
     * which indicates that this field has not been set.
     * This field can be set through the setProjectPhase method and retrieved through the getProjectPhase method.
     */
    private long projectPhase = UNSET_PROJECT_PHASE;
    ...
    /**
     * Sets the project phase the upload is associated with. This method does not allow the project phase
     * (once set) to be unset, but it does allow the project phase to be changed.
     *
     * @param projectPhase The project phase the upload is associated with
     * @throws IllegalArgumentException If projectPhase is <= 0
     */
    public void setProjectPhase(long projectPhase) {
        DeliverableHelper.checkGreaterThanZero(project, "projectPhase", null);
        this.projectPhase = projectPhase;
    }

    /**
     * Gets the project phase that the upload is associated with. This method will return
     * UNSET_PROJECT_PHASE or a value greater than 0.
     *
     * @return The project phase the upload is associated with.
     */
