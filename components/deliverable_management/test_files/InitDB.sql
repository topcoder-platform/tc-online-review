...
INSERT INTO submission_type_lu(submission_type_id, name, description, create_user, create_date, modify_user, modify_date)  VALUES(1, 'Design', 'Design', 'System', CURRENT, 'System', CURRENT);
INSERT INTO submission_type_lu(submission_type_id, name, description, create_user, create_date, modify_user, modify_date)  VALUES(2, 'Spec', 'Spec', 'System', CURRENT, 'System', CURRENT);
...
INSERT INTO submission (submission_id, submission_status_id, submission_type_id, feedback_thumb, user_rank, mark_for_purchase, create_user, create_date, modify_user, modify_date) VALUES (1, 4, 1, 't', 1, 'f', 'System', CURRENT, 'System', CURRENT);
INSERT INTO submission (submission_id, submission_status_id, submission_type_id, feedback_thumb, user_rank, mark_for_purchase, create_user, create_date, modify_user, modify_date) VALUES (2, 1, 1, 't', 2, 't', 'System', CURRENT, 'System', CURRENT);
INSERT INTO submission (submission_id, submission_status_id, submission_type_id, feedback_thumb, user_rank, mark_for_purchase, create_user, create_date, modify_user, modify_date) VALUES (3, 1, 2, 'f', 3, 't', 'System', CURRENT, 'System', CURRENT);
INSERT INTO submission (submission_id, submission_status_id, submission_type_id, feedback_thumb, user_rank, mark_for_purchase, create_user, create_date, modify_user, modify_date) VALUES (4, 4, 2, 'f', 3, 'f', 'System', CURRENT, 'System', CURRENT);
INSERT INTO submission (submission_id, submission_status_id, submission_type_id, feedback_thumb, user_rank, mark_for_purchase, create_user, create_date, modify_user, modify_date) VALUES (5, 4, 1, 't', 4, 'f', 'System', CURRENT, 'System', CURRENT);

INSERT INTO upload_submission (submission_id, upload_id) VALUES (1, 1);
INSERT INTO upload_submission (submission_id, upload_id) VALUES (2, 2);
INSERT INTO upload_submission (submission_id, upload_id) VALUES (3, 5);
INSERT INTO upload_submission (submission_id, upload_id) VALUES (4, 4);
INSERT INTO upload_submission (submission_id, upload_id) VALUES (5, 3);


INSERT INTO deliverable_lu (deliverable_id, phase_type_id, resource_role_id, name, description, required, create_user, create_date, modify_user, modify_date) VALUES (1, 1, 1, 'name1', 'name1', 0, 'System', CURRENT, 'System', CURRENT);
INSERT INTO deliverable_lu (deliverable_id, phase_type_id, resource_role_id, name, description, required, create_user, create_date, modify_user, modify_date) VALUES (2, 1, 1, 'name2', 'name2', 0, 'System', CURRENT, 'System', CURRENT);
INSERT INTO deliverable_lu (deliverable_id, phase_type_id, resource_role_id, name, description, required, create_user, create_date, modify_user, modify_date) VALUES (3, 3, 4, 'name3', 'name3', 1, 'System', CURRENT, 'System', CURRENT);
INSERT INTO deliverable_lu (deliverable_id, phase_type_id, resource_role_id, name, description, required, create_user, create_date, modify_user, modify_date) VALUES (4, 1, 5, 'name4', 'name4', 1, 'System', CURRENT, 'System', CURRENT);
INSERT INTO deliverable_lu (deliverable_id, phase_type_id, resource_role_id, name, description, required, create_user, create_date, modify_user, modify_date) VALUES (5, 4, 2, 'name5', 'name5', 1, 'System', CURRENT, 'System', CURRENT);
