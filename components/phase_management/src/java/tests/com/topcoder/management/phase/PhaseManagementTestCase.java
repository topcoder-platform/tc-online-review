...
public class PhaseManagementTestCase extends TestCase {
     ...
     * A sample project.
     */
    protected static final Project PROJECT = new Project(new Date(),
            new DefaultWorkdaysFactory(false).createWorkdaysInstance());
     ...
     */
    static final Project PROJECT_TWO = new Project(new Date(),
            new DefaultWorkdaysFactory(false).createWorkdaysInstance());
    ...
    static final PhaseHandler NEVER_PERFORM = new PhaseHandler() {
        ...
        public OperationCheckResult canPerform(Phase phase) {
            return new OperationCheckResult("never performed");
        }
