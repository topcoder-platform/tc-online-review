...
public class PhaseValidationException extends BaseCriticalException {
     ...
     * @since 1.1
     */
    public PhaseValidationException(String message, ExceptionData data) {
        super(message, data);
    }
     ...
     * @since 1.1
     */
    public PhaseValidationException(String message, Throwable cause, ExceptionData data) {
