...
/**
 * <p>
 * A simple data structure that encapsulates type/operation pairs for use as keys in the handler registry maintained by
 * <code>PhaseManager</code>. As such its only methods are accessors and methods necessary to make it usable as a key
 * in a <code>HashMap</code>.
 * </p>
 * <p>
 * HandlerRegistryInfo is immutable and therefore thread safe.
 * </p>
...
public class HandlerRegistryInfo {
    ...
    /**
     * Returns the hash code for this object. The hash code is formed by taking the exclusive or of the hash codes of
     * the type and the operation name.
