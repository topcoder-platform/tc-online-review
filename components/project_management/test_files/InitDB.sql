...
INSERT INTO project (project_id, project_status_id, project_category_id, create_user, create_date, modify_user, modify_date, project_studio_spec_id) VALUES (1, 7, 1, 'A', CURRENT, 'System', CURRENT, 1);
INSERT INTO project (project_id, project_status_id, project_category_id, create_user, create_date, modify_user, modify_date, project_studio_spec_id) VALUES (2, 1, 1, 'B', CURRENT, 'System', CURRENT, 1);
INSERT INTO project (project_id, project_status_id, project_category_id, create_user, create_date, modify_user, modify_date, project_studio_spec_id) VALUES (3, 7, 2, 'C', CURRENT, 'E', CURRENT, 1);
INSERT INTO project (project_id, project_status_id, project_category_id, create_user, create_date, modify_user, modify_date, project_studio_spec_id) VALUES (4, 1, 3, 'D', CURRENT, 'System', CURRENT, 2);
INSERT INTO project (project_id, project_status_id, project_category_id, create_user, create_date, modify_user, modify_date, project_studio_spec_id) VALUES (5, 3, 4, 'System', CURRENT, 'System', CURRENT, 1);
