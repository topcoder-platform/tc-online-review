 ...
 *
 * @ Sun14AnalyzerAccuracyTests.java
 */
 ...
 * by the <code>BaseAnalyzer</code> class by <code>Sun14Analyzer</code>.
 * </p>
 *
 * @author zmg
 * @version 2.0
 */
public class Sun14AnalyzerAccuracyTests extends TestCase {
    ...
    /**
    * <p>
    * The instance of <c>Sun14Analyzer</c> used for tests.
    * </p>
    */
    private Sun14Analyzer test = new Sun14Analyzer();
    ...
    /**
     * <p>
     * Test suite of <code>Sun14AnalyzerAccuracyTests</code>.
     * </p>
     *
     * @return Test suite of <code>Sun14AnalyzerAccuracyTests</code>.
     */
    public static Test suite() {
        return new TestSuite(Sun14AnalyzerAccuracyTests.class);
    }
    ...
    public void setUp() throws Exception {
        ...
        System.setProperty("java.class.version", "48.0");
    ...
    /**
     * <p>
     * Accuracy Test of the <code>getFieldSize()</code> method in <code>Sun14Analyzer</code>
     * class.
     * </p>
     *
    ...
    public void testGetFieldSize() throws Exception {
        // get the field size of Double.
        assertEquals("equal field size excepted", 8,
            test.getFieldSize(Long.TYPE));

        //get the field size of Float.
        assertEquals("equal field size excepted", 4,
            test.getFieldSize(Float.TYPE));

        // get the field size of Short.
        assertEquals("equal field size excepted", 2,
            test.getFieldSize(Short.TYPE));

        // get the field size of Boolean.
        assertEquals("equal field size excepted", 1,
            test.getFieldSize(Boolean.TYPE));

        // get the field size of Boolean.
        assertEquals("equal field size excepted", 4,
            test.getFieldSize(Map.class));
    }
     ...
     * @throws Exception exception to JUnit.
     */
    public void testSun14AccuracyCustomClass_Deep() throws Exception {
     ...
     * @throws Exception exception to JUnit.
     */
    public void testSun14AccuracyCustomClass_Simple() throws Exception {
        // size : 8 + 1 + 2 + 4 = 15 -> 16
        assertEquals("class SimpleClassA size not correct", 16,
     ...
     * @throws Exception exception to JUnit.
     */
    public void testSun14AccuracyBuiltInClass_Deep() throws Exception {
     ...
     * @throws Exception exception to JUnit.
     */
    public void testSun14AccuracyCustomClass_Shallow()
        throws Exception {
     ...
     * @throws Exception exception to JUnit.
     */
    public void testSun14AccuracyArray_Shallow() throws Exception {
     ...
     * @throws Exception exception to JUnit.
     */
    public void testSun14AccuracyNull_Shallow() throws Exception {
...
/**
 * <p>
 * Class which contains some primitive variables used for test.
 * </p>
 *
 * @author zmg
 * @version 2.0
...
/**
 * <p>
 * Class which contains some primitive variables and null used for test.
 * </p>
 *
 * @author zmg
 * @version 2.0
...
/**
 * <p>
 * Class which contains a self-reference and a static member.
 * </p>
 *
 * @author zmg
 * @version 2.0
 */
class TestA {
    private static Object y = "This is a pretty long String";
    private Object x;
    protected int z;
...
/**
 * <p>
 * Subclass of <code>TestA</code> used for test.
 * </p>
 * @author zmg
 * @version 2.0
 */
class TestB extends TestA {
    private static Object y = "This is a an even longer String";
    protected int x;
...
/**
 * <p>
 * Subclass which contains a self-reference and null member
 * It is a subclass of <code>TestB</code> used for test.
 * </p>
 *
 * @author zmg
 * @version 2.0
...
/**
 * <p>
 * Class whose subclass is used to test shallow memory usage.
 * </p>
 *
 * @author zmg
 * @version 2.0
...
/**
 * <p>
 * Class used to test shallow memory usage.
 * It is a subclass of <code>TestD</code>.
 * </p>
 *
 * @author zmg
 * @version 2.0
