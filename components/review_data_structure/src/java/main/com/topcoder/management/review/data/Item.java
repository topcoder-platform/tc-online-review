...
public class Item implements Serializable {
     ...
     * </p>
     */
    private Serializable answer = null;
    ...
    public void setQuestion(long question) {
        if (question <= 0) {
            throw new IllegalArgumentException("question should be positive.");
        }
    ...
    public void setDocument(Long document) {
        if (document != null && document.longValue() <= 0) {
            throw new IllegalArgumentException("document should not wrap a non-positive value");
        }
