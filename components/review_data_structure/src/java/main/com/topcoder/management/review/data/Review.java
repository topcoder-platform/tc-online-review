...
public class Review implements Serializable {
     ...
     * </p>
     */
    private Double initialScore = null;
    ...
    public void setAuthor(long author) {
        if (author <= 0) {
            throw new IllegalArgumentException("author should be positive.");
        }
        this.author = author;
    }
    ...
    public void setSubmission(long submission) {
        if (submission <= 0) {
            throw new IllegalArgumentException("submission should be positive.");
        }
    ...
    public void setScorecard(long scorecard) {
        if (scorecard <= 0) {
            throw new IllegalArgumentException("scorecard should be positive.");
        }
    ...
    public void setScore(Double score) {
        if (score != null && (score < 0 || Double.isNaN(score) || Double.isInfinite(score))) {
            throw new IllegalArgumentException("the wrapped value should not be negative, NaN or POSITIVE_INFINITY.");
        }
        this.score = score;
    }
    ...
    public void setInitialScore(Double initialScore) {
        if (initialScore != null && (initialScore < 0 || Double.isNaN(initialScore)
                || Double.isInfinite(initialScore))) {
            throw new IllegalArgumentException("the wrapped value should not be negative, NaN or POSITIVE_INFINITY.");
        }
