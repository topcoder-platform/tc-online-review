...
/**
 * <p>
 * Unit tests for {@link ReviewAuctionCategory} class.
 * </p>
 *
 * @author sparemax
 * @version 1.0
 */
public class ReviewAuctionCategoryUnitTests {
    /**
     * <p>
     * Represents the <code>ReviewAuctionCategory</code> instance used in tests.
     * </p>
     */
    private ReviewAuctionCategory instance;
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(ReviewAuctionCategoryUnitTests.class);
    }

    /**
     * <p>
     * Accuracy test for the constructor <code>ReviewAuctionCategory(long id, String name)</code>.<br>
     * Instance should be correctly created.
     * </p>
     */
    @Test
    public void testCtor() {
        instance = new ReviewAuctionCategory(id, name);
    ...
    public void test_toString_2() {
        instance = new ReviewAuctionCategory(0, null);
