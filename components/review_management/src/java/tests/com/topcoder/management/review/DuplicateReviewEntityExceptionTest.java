...
/**
 * <p>
 * This class tests the <code>DuplicateReviewEntityException</code> class.
 * </p>
 *
 * <p>
...
public class DuplicateReviewEntityExceptionTest extends TestCase {
    ...
    /**
     * <p>
     * <code>DuplicateReviewEntityException</code> should be subclass of <code>ReviewPersistenceException</code>.
     * </p>
     *
     * @since 1.2
     */
    public void testInheritance() {
        assertTrue("DuplicateReviewEntityException should be subclass of ReviewPersistenceException.",
            DuplicateReviewEntityException.class.getSuperclass() == ReviewPersistenceException.class);
    }

    /**
     * <p>
     * Tests accuracy of <code>DuplicateReviewEntityException(String, long)</code> constructor.<br>
     * The detail error message should be properly set.
     * </p>
     */
    public void testCtor1() {
        DuplicateReviewEntityException exception = new DuplicateReviewEntityException(DETAIL_MESSAGE, ID);
    ...
    /**
     * <p>
     * Tests accuracy of <code>DuplicateReviewEntityException(String, Throwable, long)</code> constructor.<br>
    ...
    public void testCtor2() {
        DuplicateReviewEntityException exception = new DuplicateReviewEntityException(DETAIL_MESSAGE, CAUSE, ID);
    ...
    /**
     * <p>
     * Tests accuracy of <code>DuplicateReviewEntityException(String, ExceptionData, long)</code> constructor.<br>
    ...
    public void testCtor3() {
        DuplicateReviewEntityException exception = new DuplicateReviewEntityException(DETAIL_MESSAGE, EXCEPTION_DATA,
            ID);
    ...
    /**
     * <p>
     * Tests accuracy of <code>DuplicateReviewEntityException(String, Throwable, ExceptionData, long)</code>
     * constructor.<br>
    ...
    public void testCtor4() {
        DuplicateReviewEntityException exception = new DuplicateReviewEntityException(DETAIL_MESSAGE, CAUSE,
            EXCEPTION_DATA, ID);
