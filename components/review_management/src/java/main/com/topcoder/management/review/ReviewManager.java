...
/**
 * <p>
 * This ReviewManager interface defines the contract of managing the review entities. It provides the management
 * functionalities to create, update, delete and search review entities. It can also be used to add comment for review
...
public interface ReviewManager {
    /**
     * <p>
     * This method creates the review entity in the manager. This method will also create the associated
     * <code>Comment</code> and <code>Item</code> instances.
     * </p>
     *
     * @param review
     ...
     *             if failed to create the review entity in the manager.
     */
    public void createReview(Review review, String operator) throws ReviewManagementException;

    /**
     * <p>
     * This method updates the review entity in the manager. This method will also be responsible for creating,
     * deleting, updating the associated <code>Item</code> instances.
     * </p>
     *
     * @param review
     ...
     * @throws ReviewManagementException
     *             if failed to update the review entity in the manager.
     */
     ...
     * @throws ReviewManagementException
     *             if failed to get the review entity from the manager.
     */
     ...
     * the associated items and comments of the matching review entity will not been retrieved.
     * </p>
     *
     * <p>
     ...
     * @throws ReviewManagementException
     *             if failed to search the review entities from the manager.
     */
    public Review[] searchReviews(Filter filter, boolean complete) throws ReviewManagementException;

    /**
     * <p>
     * This method will add comment to review with given review id. This method is also responsible for creating the
     ...
     * @throws ReviewManagementException
     *             if failed to add comment for the review entity in the manager.
     */
    public void addReviewComment(long reviewId, Comment comment, String operator) throws ReviewManagementException;

    /**
     * <p>
     * This method will add the comment to the item with given item id. This method is also responsible for creating
     * the <code>Comment</code> instance.
     * </p>
     *
     * @param itemId
     *            the item id.
     ...
     * @throws ReviewManagementException
     *             if failed to add comment for the item entity in the manager.
     */
    public void addItemComment(long itemId, Comment comment, String operator) throws ReviewManagementException;
     ...
     *
     * @throws ReviewManagementException
     *             if failed to get all comment types from manager.
     */
     ...
     * @throws ReviewManagementException
     *             if failed to remove review together with associated entities.
     *
     * @since 1.2
     */
    public void removeReview(long id, String operator) throws ReviewManagementException;
}
