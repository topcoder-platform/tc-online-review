...
/**
 * A mock implementation of the ScoreCalculator interface that doesn't have a public namespace constructor.
 *
 * @author      UFP2161
 * @copyright   Copyright (C) 2006 TopCoder Inc., All Rights Reserved.
 * @version     1.0
 */
public class MockNoNamespaceCtorScoreCalculator implements ScoreCalculator {
     ...
     *          Ignored.
     */
    public MockNoNamespaceCtorScoreCalculator(int namespace) {
        // Do nothing.
    }
