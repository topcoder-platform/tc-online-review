...
INSERT INTO deliverable_lu(deliverable_id, phase_type_id, resource_role_id, submission_type_id, required, name, description, create_user, create_date, modify_user, modify_date) VALUES(2, 3, 3, 2, 0, 'deliverable 2', 'non per submission deliverable', 'System', CURRENT, 'System', CURRENT);