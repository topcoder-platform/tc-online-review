...
INSERT INTO submission(submission_id, submission_status_id, submission_type_id, feedback_thumb, user_rank, mark_for_purchase, create_user, create_date, modify_user, modify_date) VALUES(1, 3, 1, 'f', 1, 't', 'System', CURRENT, 'System', CURRENT);

INSERT INTO submission(submission_id, submission_status_id, submission_type_id, feedback_thumb, user_rank, mark_for_purchase, create_user, create_date, modify_user, modify_date) VALUES(2, 1, 2, 't', 2, 'f', 'System', CURRENT, 'System', CURRENT);
