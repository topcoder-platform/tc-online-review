...
public class SqlDeliverablePersistenceAccuracyTest extends TestCase {
    ...
    public void testLoadDeliverables1() throws Exception {
        Deliverable[] deliverables = tester.loadDeliverables(1, 1, 1);
    ...
    public void testLoadDeliverables1_PerSubmissionFalse() throws Exception {
        Deliverable[] deliverables = tester.loadDeliverables(3, 2, 3);

        assertEquals("One deliverable should be returned.", 1, deliverables.length);
        ...
        assertEquals("Failed to load deliverable.", 1, projects.size());
    }
    ...
    public void testLoadDeliverable() throws Exception {
        Deliverable deliverable = tester.loadDeliverable(1, 1, 1, 1);
    ...
    public void testLoadDeliverables2() throws Exception {
        Deliverable[] deliverables = tester.loadDeliverables(new long[] { 1, 2, 1, 1000 },
                                         new long[] { 1, 1, 3, 1000 }, new long[] { 1,
                1, 1, 1 });
    ...
    public void testLoadDeliverables3() throws Exception {
        Deliverable[] deliverables = tester.loadDeliverables(new long[] { 1, 2, 1, 1000 }, new long[] { 1, 1, 3, 2 },
                                         new long[] { 1,
                1, 1, 1 });
    ...
    public void testLoadDeliverables3_Empty() throws Exception {
        assertEquals("when the give id pairs is emtpy, empty array should be returned.", 0,
                     tester.loadDeliverables(new long[0], new long[0], new long[0]).length);
    }
    ...
    private void predefineObject() {
        ...
        {
            PREDEFINED_DELIVERABLE = new Deliverable[] { new Deliverable(1, 1, 1, new Long(1), true),
                    new Deliverable(1, 2, 2, new Long(1), false), new Deliverable(1, 3, 2, new Long(2), true),
