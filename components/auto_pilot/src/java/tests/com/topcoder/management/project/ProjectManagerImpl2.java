 ...
 * @version 1.0
 */
public class ProjectManagerImpl2 implements ProjectManager {
     ...
     */
    public ProjectManagerImpl2() throws ConfigurationException {
        // your code here
        projects = new Project[1];
        types = new ProjectType[1];
        stats = new ProjectStatus[1];
        categories = new ProjectCategory[1];
        propertyTypes = new ProjectPropertyType[1];
     ...
     *             required configuration parameter is missing.
     */
    public ProjectManagerImpl2(String ns) throws ConfigurationException {
        // your code here
        this();
    }
