 ...
 * </p>
 * <p>
 * This implementation create phases for tests. It contains one project, which contains 3 phases:
 * Screening, Review, Appeal. At start, Screening is CLOSE, Review is OPEN, Appeal is SCHEDULED.
 * Review can be ended, Appeal can be started.
 * </p>
 * @author TCSDESIGNER, TCSDEVELOPER
 * @version 1.0
 */
public class DefaultPhaseManager2 implements PhaseManager {
     ...
     */
    public DefaultPhaseManager2(String namespace) throws ConfigurationException {
     ...
     */
    public DefaultPhaseManager2(PhasePersistence persistence, IDGenerator idGenerator) {
        // your code here
    ...
    private void createPhases() {
        ...
        // Review.
        Phase phase2 = new Phase(proj, 8 * 3600 * 1000);
        phase2.setId(2);
        phase2.setPhaseType(new PhaseType(2, "PhaseType#2"));
        phase2.setPhaseStatus(PhaseStatus.OPEN);
        phase2.addDependency(new Dependency(phase1, phase2, false, true, 10));
        proj.addPhase(phase2);
        phases[1] = phase2;

        // Appeal
        Phase phase3 = new Phase(proj, 12 * 3600 * 1000);
        phase3.setPhaseType(new PhaseType(3, "PhaseType#3"));
        phase3.setPhaseStatus(PhaseStatus.SCHEDULED);
        phase3.setId(3);
        phase3.addDependency(new Dependency(phase2, phase3, true, false, 10));
        proj.addPhase(phase3);
        phases[2] = phase3;
