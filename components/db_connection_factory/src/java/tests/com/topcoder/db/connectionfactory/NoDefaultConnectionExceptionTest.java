...
/**
 * <p>
 * Tests NoDefaultConnectionException class, really dummy test, it should throw valid error message
 * and have proper cause.
 * </p>
 * <p>
 ...
 * @since 1.0
 */
public class NoDefaultConnectionExceptionTest extends TestCase {
    /**
     * An exception instance used to create the NoDefaultConnectionException. *
     */
    ...
    public void testCtor1() {
        BaseException be = new NoDefaultConnectionException("dummy");
    ...
    public void testCtor1WithNullMessage() {
        // no error
        new NoDefaultConnectionException((String) null);
    }
    ...
    public void testCtor1WithEmptyMessage() {
        // no error
        new NoDefaultConnectionException("");
    }
    ...
    public void testCtor2() {
        BaseException bre = new NoDefaultConnectionException("dummy", cause);

        assertTrue("The inner exception should match", bre.getCause() instanceof IllegalArgumentException);
    ...
    public void testCtor2WithNullMessage() {
        // no error
        new NoDefaultConnectionException((String) null, cause);
    }
    ...
    public void testCtor2WithEmptyMessage() {
        // no error
        new NoDefaultConnectionException("", cause);
    }
    ...
    public void testCtor2WithNullInnerException() {
        // no error
        new NoDefaultConnectionException("dummy", null);
    }
