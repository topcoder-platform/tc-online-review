 ...
 * context is the driver for a configuration file, required for the IDGenerator.
 *
 * @author qiucx0161
 * @version 1.0
 */
...
class MockContext extends InitialContext {
    ...
    /**
     * In this simple mock implementation, this method only ever returns a DataSource object
     * pointing at the database used for unit testing.
     *
     * @param key Ignored
     *
...
/**
 * Mock implementation of DataSource that only ever points at my personal copy of database (depends
 * on the configuration file) for unit testing purposes only.
 */
class MockDataSource implements DataSource {
    /**
     * The the configuration file to load the necessary configuration values to create a
     * connection.
     */
