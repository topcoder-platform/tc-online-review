...
/**
 * <p>
 * <code>PhaseGenerationException</code> indicates that there're errors in the project phases generation
 * process, e.g. the cyclic dependency, a phase depends on an undefined phase, etc.
 * </p>
 * <p>
 * It may be thrown from <code>{@link PhaseTemplatePersistence}</code> and <code>{@link PhaseTemplate}</code>
 * implementations.
 * </p>
 *
...
public class PhaseGenerationException extends PhaseTemplateException {
    ...
    /**
     * <p>
     * Create <code>PhaseGenerationException</code> instance with error message and the cause exception.
     * </p>
     *
     * @param message
     *            the error message
