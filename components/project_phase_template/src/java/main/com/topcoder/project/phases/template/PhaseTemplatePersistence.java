...
/**
 * <p>
 * <code>PhaseTemplatePersistence</code> interface acts as the persistence layer of the phase templates, so
 * that the persistence is pluggable and can be added without code changes. It manages a set of templates,
 * provides the API to generate an array of Phases from a template it manages and add the phases to a given
 * <code>Project</code>.
 * </p>
 * <p>
 * Note that this interface generates only phases, the <code>Project</code> generation is out of the scope of
 * this interface.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * In this initial release, the persistence is readonly, all templates are not modifiable with this
 * component.The template authoring functionalities may be added in the future versions.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * Implementations should be thread safe, and it is easy to achieve in the initial release as the templates
 * are readonly.
 * </p>
 * <p>
