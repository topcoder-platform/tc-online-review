 ...
 * </p>
 * <p>
 * It generates a relative time in a week as the default start date. The relative time is specified by the
 * following values:
 * </p>
 * <ol>
...
public class RelativeWeekTimeStartDateGenerator implements StartDateGenerator {
    ...
    /**
     * <p>
     * Represents the valid range of hour field, the first element is the min value, the second element is the
     * max value.
     * </p>
     */
    ...
    /**
     * <p>
     * Represents the valid range of minute field, the first element is the min value, the second element is
     * the max value.
     * </p>
     */
    ...
    /**
     * <p>
     * Represents the valid range of second field, the first element is the min value, the second element is
     * the max value.
     * </p>
     */
    ...
    /**
     * <p>
     * Represents the valid range of dayOfWeek field, the first element is the min value, the second element
     * is the max value.
     * </p>
     */
    ...
    /**
     * <p>
     * Represents the hour value in 24-hour clock of the relative time to generate.
     * </p>
     * <p>
     * It is initialized in constructor, can be accessed by the getter and can not be modified afterwards.The
     * valid values will be from 0 to 23.
     * </p>
     */
     ...
     * <p>
     * It is initialized in constructor, can be accessed by the getter and can not be modified afterwards.The
     * valid values will be from 0 to 59.
     * </p>
     */
     ...
     * <p>
     * It is initialized in constructor, can be accessed by the getter and can not be modified afterwards.The
     * valid values will be from 1 to 7, which represents Sunday to Saturday respectively.
     * </p>
     */
     ...
     * </p>
     * <p>
     * E.g. 1 means the next week, 0 means current week, -1 means the past week(though generally it is rarely
     * used as a start date.).
     * </p>
     * <p>
     * It is initialized in the constructor,can be accessed by the getter and can not be modified
     * afterwards.Any integer values are valid.
     * </p>
     */
    ...
    /**
     * <p>
     * Create <code>RelativeWeekTimeStartDateGenerator</code> instance from the configuration namespace.
     * </p>
     *
     * @param namespace
     *            the configuration namespace
     * @throws ConfigurationException
     *             if the namespace is not loaded or any
    ...
    public RelativeWeekTimeStartDateGenerator(String namespace) throws ConfigurationException {
        ...
        try {
            ...
            this.dayOfWeek = checkIntegerRange(DAY_OF_WEEK_RANGE,
                Integer.parseInt(cm.getString(namespace, KEY_DAY_OF_WEEK)), KEY_DAY_OF_WEEK);
    ...
    /**
     * <p>
     * Create <code>RelativeWeekTimeStartDateGenerator</code> instance with given values.
     * </p>
     *
     * @param dayOfWeek
     *            the day of the week
     * @param hour
     *            the hour value in 24-hour clock
     * @param minute
     *            the minute value
     * @param second
     *            the second value
     * @param weekOffset
     *            the week offset from current week
     * @throws IllegalArgumentException
     *             if hour is not in [0, 23] or minute is
    ...
    /**
     * <p>
     * Generate a start date according to a "relative time in a week" generation logic.
     * </p>
     * <p>
     * It generates a relative time in a week as the default start date.
     * </p>
     * <p>
     * For example, given the next values: (weekOffSet, dayOfWeek, hour, minute, second) = (1, 5, 9, 0, 0)
     * Then 9:00:00 AM next Thursday will be generated, just as the TCS project posting time in the next week.
     * </p>
     *
