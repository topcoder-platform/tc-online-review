...
public class PhaseTemplateException extends BaseException {
    ...
    /**
     * <p>
     * Create <code>PhaseTemplateException</code> instance with the error message.
     * </p>
     *
     * @param message
     *            the error message
    ...
    /**
     * <p>
     * Create <code>PhaseTemplateException</code> instance with error message and the cause exception.
     * </p>
     *
     * @param message
     *            the error message
