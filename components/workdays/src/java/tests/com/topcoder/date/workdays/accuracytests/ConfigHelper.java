...
/**
 * <p>
 * This package private class is used to get the configured ConfigManger, only contains one static method. Please see
 * the doc of the method for more details.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
...
class ConfigHelper {
     ...
     * </p>
     */
    public static String LOCATION_CONFIG = "test_files/accuracytests/defaultWorkdaysFactory.properties";
     ...
     *             if any config exception occurs
     */
    public static ConfigManager initialConfigManager() throws ConfigManagerException {
        ...
        cm.add(NAMESPACE, LOCATION_CONFIG, ConfigManager.CONFIG_PROPERTIES_FORMAT);
