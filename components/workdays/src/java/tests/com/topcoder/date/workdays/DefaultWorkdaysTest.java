...
public class DefaultWorkdaysTest extends TestCase {
     ...
     *
     * @throws Exception
     *             if the configuration file wasn't configged correctly
     */
     ...
     *             if errors occer when change the properties in configManager
     */
    public void testConstructorWithIllegalStartTimeHours() throws ConfigManagerException {
     ...
     *
     * @throws ConfigManagerException
     *             if errors occur when change the properties in configManager
     */
    public void testConstructorWithIllegalStartTimeMinutes() throws ConfigManagerException {
     ...
     *             if errors occer when change the properties in configManager
     */
    public void testConstructorWithIllegalEndTimeHours() throws ConfigManagerException {
     ...
     *             if errors occer when change the properties in configManager
     */
    public void testConstructorWithIllegalEndTimeMinutes() throws ConfigManagerException {
     ...
     *             if errors occer when change the properties in configManager
     */
    public void testConstructorWithIllegalTimeRelationShip() throws ConfigManagerException {
        try {
            ...
            assertEquals("Test for validation of property relationship", IllegalArgumentException.class, cfe.getCause()
                    .getClass());
            assertTrue("Test for validation of property relationship", cfe.getCause().getMessage().startsWith(
                    "The start time is after the end time"));
        }
    }

    /**
     * Test constructing a DefaultWorkdays instance using <code>DefaultWorkdays(fileName,fileFormat)</code> when the
     * fileName is null.
     *
     * @throws Exception
     *             to JUnit.
    ...
    public void testConstructor1() throws Exception {
        try {
            workdays = new DefaultWorkdays(null, DefaultWorkdays.XML_FILE_FORMAT);
    ...
    public void testConstructor2() throws Exception {
        try {
            workdays = new DefaultWorkdays("\n", DefaultWorkdays.XML_FILE_FORMAT);
    ...
    public void testConstructor3() throws Exception {
        try {
            workdays = new DefaultWorkdays(PROPERTIES_FILE_NAME, null);
            fail("should throw NullPointerException");
        } catch (NullPointerException e) {
            // ignore
        }
    ...
    /**
     * Test constructing a DefaultWorkdays instance using <code>DefaultWorkdays(fileName,fileFormat)</code> when the
     * fileFormat is not the format required.
     *
     * @throws Exception
     *             to JUnit.
     */
    public void testConstructor4() throws Exception {
        try {
            workdays = new DefaultWorkdays(PROPERTIES_FILE_NAME, "txt");
            fail("should throw IllegalArgumentException");
        } catch (IllegalArgumentException e) {
            // ignore
        }
    ...
    /**
     * Test constructing a DefaultWorkdays instance using <code>DefaultWorkdays(fileName)</code> when the default
     * configuration is <code>null</code>.
     */
    public void testConstructor5() {
        try {
            workdays = new DefaultWorkdays("test_files/error4.xml");
            fail("should throw ConfigurationFileException");
        } catch (ConfigurationFileException e) {
            assertEquals("default configuration should not be null", e.getMessage());
        }
    }

    /**
     * Test constructing a DefaultWorkdays instance using <code>DefaultWorkdays(fileName)</code> when isSaturdayWorkday
     * is set <code>null</code>.
     */
    public void testConstructor6() {
        try {
            workdays = new DefaultWorkdays("test_files/error2.properties");
            fail("should throw ConfigurationFileException");
        } catch (ConfigurationFileException e) {
            // ignore
        }
    ...
    public void testConstructor7() {
        try {
            workdays = new DefaultWorkdays("test_files/error3.properties");
            fail("should throw ConfigurationFileException");
        } catch (ConfigurationFileException e) {
            // ignore
        }
    ...
    /**
     * Test constructing a DefaultWorkdays instance using <code>DefaultWorkdays(fileName)</code> when the startTimeHour
     * is <code>null</code>.
     */
    public void testConstructor8() {
        try {
            workdays = new DefaultWorkdays("test_files/error5.properties");
            fail("should throw ConfigurationFileException");
        } catch (ConfigurationFileException e) {
            // ignore
        }
    ...
    /**
     * Test constructing a DefaultWorkdays instance using <code>DefaultWorkdays(fileName)</code> when the nonWorkDays is
     * <code>null</code>.
     *
     * @throws Exception
     *             to JUnit
    ...
    public void testConstructor9() throws Exception {
        workdays = new DefaultWorkdays("test_files/sample2.properties");
        assertEquals(0, workdays.getNonWorkdays().size());
    }

    /**
     * Test constructing a DefaultWorkdays instance using <code>DefaultWorkdays(fileName)</code> when ParseException is
     * thrown.
     */
    public void testConstructor10() {
        try {
            workdays = new DefaultWorkdays("test_files/error6.properties");
            fail("should throw ConfigurationFileException");
        } catch (ConfigurationFileException e) {
            // ignore
        }
    ...
    /**
     * Test constructing a DefaultWorkdays instance using <code>DefaultWorkdays(fileName)</code> when the fileName is
     * empty.
     *
     * @throws Exception
     *             to JUnit.
    ...
    /**
     * Test constructing a DefaultWorkdays instance using <code>DefaultWorkdays(fileName)</code>.
     *
     * @throws Exception
     *             to JUnit.
     */
    public void testConstructorAccuracy() throws Exception {
        workdays = new DefaultWorkdays("test_files/sample.properties");
        assertNotNull("Test instance created by DefaultWorkdaysFactory", workdays);
        assertEquals("Test the file_name", "test_files/sample.properties", workdays.getFileName());
        assertEquals(16, workdays.getWorkdayEndTimeHours());
        assertEquals(0, workdays.getWorkdayEndTimeMinutes());
        assertEquals(8, workdays.getWorkdayStartTimeHours());
        assertEquals(0, workdays.getWorkdayStartTimeMinutes());
        assertEquals(3, workdays.getNonWorkdays().size());
        assertEquals(true, workdays.isSaturdayWorkday());
        assertEquals(false, workdays.isSundayWorkday());
    }
     ...
     *             to JUnit.
     */
    public void testConstructorWithNullfileName() throws Exception {
        try {
            workdays = new DefaultWorkdays(null);
            fail("should throw IllegalArgumentException");
        } catch (IllegalArgumentException e) {
            // ignore
        }
     ...
     *             to JUnit.
     */
    public void testSetFileNameIllegally() throws Exception {
        try {
    ...
    /**
     * Test saving using Configuration Persistence when nonWorkdays is <code>null</code>.
     *
     * @throws Exception
     *             to JUnit.
     */
    public void testSave1() throws Exception {
        DefaultWorkdays instance = new DefaultWorkdays("test_files/sample2.properties");
        // save as XML
        instance.setFileFormat(DefaultWorkdays.XML_FILE_FORMAT);
        instance.setFileName("test_files/saveasdefault2.xml");
        instance.save();
    }

    /**
     * Test saving using Configuration Persistence.
     *
     * @throws Exception
     *             to JUnit.
     */
    public void testSave2() throws Exception {
        DefaultWorkdays instance = new DefaultWorkdays("test_files/sample.properties");
        instance.addNonWorkday(new Date());
        // save as XML
        instance.setFileFormat(DefaultWorkdays.XML_FILE_FORMAT);
        instance.setFileName("test_files/saveasdefault2.xml");
        instance.save();
    ...
    /**
     * Test saving using Configuration manager when NonWorkdays is null.
     *
     * @throws Exception
     *             to JUnit.
     */
    public void testSave3() throws Exception {
        DefaultWorkdays instance = new DefaultWorkdays("test_files/sample3.properties",
                DefaultWorkdays.PROPERTIES_FILE_FORMAT);
        assertEquals(0, instance.getNonWorkdays().size());
        // save as XML
        instance.setFileFormat(DefaultWorkdays.XML_FILE_FORMAT);
        instance.setFileName("test_files/saveasdefault2.xml");
        instance.save();
    ...
    /**
     * Failure test saving using Configuration API and Configuration Persistence because UnrecognizedFileTypeException
     * throws.
     *
     * @throws Exception
     *             to JUnit.
    ...
    public void testSave4() throws Exception {
        ...
        try {
            instance.setFileFormat(DefaultWorkdays.XML_FILE_FORMAT);
            instance.setFileName("saveasdefault2.text");
            instance.save();
            fail("should throw ConfigurationFileException");
        } catch (ConfigurationFileException e) {
            assertEquals(UnrecognizedFileTypeException.class, e.getCause().getClass());
            File file = new File("saveasdefault2.text");
            file.delete();
        }
    }
    ...
    /**
     * Test refresh failure when throw IOException because could not find the file.
     *
     * @throws Exception
     *             to JUnit.
     */
    public void testRefreshfailure1() throws Exception {
        try {
            DefaultWorkdays instance = new DefaultWorkdays("a:bc");
            instance.refresh();
            fail("should throw ConfigurationFileException");
        } catch (ConfigurationFileException e) {
    ...
    /**
     * Test refresh failure when throw ConfigurationParserException because could not parser.
     *
     * @throws Exception
     *             to JUnit.
     */
    public void testRefreshfailure2() throws Exception {
        try {
            DefaultWorkdays instance = new DefaultWorkdays("error1.properties");
            fail("should throw ConfigurationFileException");
        } catch (ConfigurationFileException e) {
            assertEquals(ConfigurationParserException.class, e.getCause().getClass());
        }
    }

    /**
     * Test refresh failure when throw ConfigurationParserException because can not read the error2.text file.
     *
     * @throws Exception
     *             to JUnit.
     */
    public void testRefreshfailure3() throws Exception {
        try {
            DefaultWorkdays instance = new DefaultWorkdays("error2.text");
            fail("should throw ConfigurationFileException");
        } catch (ConfigurationFileException e) {
            assertEquals(UnrecognizedFileTypeException.class, e.getCause().getClass());
        }
    ...
    /**
     * Test refresh when name space is already loaded.
     *
     * @throws Exception
     *             to JUnit.
     */
    public void testRefresh() throws Exception {
        DefaultWorkdays instance = new DefaultWorkdays("test_files/sample.properties");
        instance.refresh();
        assertEquals(3, instance.getNonWorkdays().size());
    }
    ...
    /**
     * Test adding nonWorkdays when the input arguments is <code>null</code>.
     */
    public void testAddNonWorkdays2() {
        try {
            workdays.addNonWorkday(null);
    ...
    /**
     * Test constructing a DefaultWorkdays with illegal property. Including three situatoins, first, the property is not
     * specified, second, the property value is smaller than the minimal value the property can be, third, the property
     * value is bigger than the maximal value the property can be.
     *
     * @param propertyName
     *            the name of property to test
     * @param lessThanMinValue
     *            the illegal value which is min_value_of_the_property - 1
     * @param moreThanMaxValue
     *            the illegal value which is max_value_of_the_property + 1
     * @param defaultValue
    ...
    private void constructorWithIllegalProperties(String propertyName, String lessThanMinValue,
        ...
        try {
            ...
            assertEquals("Test for validation of property " + propertyName, IllegalArgumentException.class, cfe
                    .getCause().getClass());
            assertTrue("Test for validation of property " + propertyName, cfe.getCause().getMessage().startsWith(
        ...
        try {
            ...
            assertEquals("Test for validation of property " + propertyName, IllegalArgumentException.class, cfe
                    .getCause().getClass());
            assertTrue("Test for validation of property", cfe.getCause().getMessage().startsWith(
                    "Property " + propertyName + " must be between "
     ...
     *
     * @param namespace
     *            the namespace name in configManager
     *
     * @throws Exception
     *             if the configuration file wasn't configged correctly
     */
    private void assertPropertiesInWorkdays(String namespace) throws Exception {
        ...
        assertEquals("Test for endTimeHours", this.configManager.getString(namespace, END_TIME_HOURS_PROPERTY), String
                .valueOf(this.workdays.getWorkdayEndTimeHours()));
        ...
        assertEquals("Test for isSaturdayWorkday", this.configManager
                .getString(namespace, IS_SATURDAY_WORKDAY_PROPERTY), String.valueOf(this.workdays.isSaturdayWorkday()));
     ...
     *
     * @throws ConfigManagerException
     *             if errors occer when set the property in configManager
     */
    private void setPropertyToConfigurationFile(String propertyName, String value) throws ConfigManagerException {
     ...
     *
     * @throws ConfigManagerException
     *             if errors occer when remove the property in configManager
     */
    private void removePropertyFromConfigurationFile(String propertyName) throws ConfigManagerException {
        this.configManager.createTemporaryProperties(PROPERTIES_NAMESPACE);
    ...
    /**
     * Test remove NonWorkday when the input date not exist.
     */
    public void testRemoveNonWorkday() {
        try {
            Date date = new Date();
    ...
    /**
     * Test remove NonWorkday when the input date is null.
     */
    public void testRemoveNonWorkday2() {
        try {
            workdays.removeNonWorkday(null);
            fail("should throw NullPointerException");
        } catch (NullPointerException e) {
            // ignore
        }
    ...
    /**
     * Test clear NonWorkdays.
     */
    public void testClearNonWorkdays() {
        workdays.clearNonWorkdays();
    }
}
