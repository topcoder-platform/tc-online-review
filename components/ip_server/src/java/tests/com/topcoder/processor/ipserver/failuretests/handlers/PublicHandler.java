...
/**
 * <p>A custom <code>Handler</code> providing a public constructor to be used for testing the <code>IPServerManager
 * </code>.</p>
 *
 * @author isv, brain_cn
 * @version 2.0
...
public class PublicHandler extends Handler {
    ...
    /**
     * <p>Constructs new <code>PublicHandler</code> with specified maximum number of requests to be handled
     * simultaneously.</p>
     *
     * @param maxRequests an <code>int</code> providing the number of maximum requests to be handled by the handler
     *        simultaneously.
     */
    public PublicHandler(int maxRequests) {
        super(maxRequests);
    }
}
