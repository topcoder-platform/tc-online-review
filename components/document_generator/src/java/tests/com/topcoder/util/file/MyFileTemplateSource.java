...
/**
 * This is class only for test. It extends {@link FileTemplateSource} and change only one things, it read from
 * config property base directory, and all operation it do in this directory.
 * @author TCSDEVELOPER
 * @version 3.0
 * @since 2.0
 */
public class MyFileTemplateSource extends FileTemplateSource {
     ...
     *             to junit
     */
    public MyFileTemplateSource(String sourceId, ConfigurationObject config)
        throws ConfigurationAccessException {
