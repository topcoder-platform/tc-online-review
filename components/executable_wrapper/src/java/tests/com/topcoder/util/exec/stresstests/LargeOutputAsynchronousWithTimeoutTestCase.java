/**
 * LargeOutputAsynchronousWithTimeoutTestCase.java
 *
 ...
 * @version 1.0
 */
public class LargeOutputAsynchronousWithTimeoutTestCase extends TestCase {
    ...
    public void testLargeOutput() {
        ...
        try {
            handle = Exec.executeAsynchronously(new String[] {exename,""+SIZE},TIMEOUT*1000);
        }
    ...
    public static Test suite() {
        return new TestSuite(LargeOutputAsynchronousWithTimeoutTestCase.class);
    }
}
