/**
 * LargeOutputSynchronousTestCase.java
 *
 ...
 * @version 1.0
 */
public class LargeOutputSynchronousTestCase extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(LargeOutputSynchronousTestCase.class);
    }
}
