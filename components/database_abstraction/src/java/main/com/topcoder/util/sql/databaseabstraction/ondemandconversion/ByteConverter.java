...
/**
 * <p>
 * The ByteConverter class handles on demand conversions from the Byte type to
 * various other data types. It implements the OnDemandConverter interface and
 * has no state.
 * </p>
 * <p>
 * When a value is converted by ByteConverter, the condition that value can be
 * converted is: value is a Byte and not null, and desiredType is Short,
 * Integer, Long, Float, Double, BigDecimal or String.
 * </p>
 * <p>
...
public class ByteConverter implements OnDemandConverter {
     ...
     * value can be converted is: value is a Byte and not null, and desiredType
     * is Short, Integer, Long, Float, Double, BigDecimal or String.
     * </p>
     * <p>
     * <strong>Changes in 2.0:</strong>
     * <ol>
    ...
    /**
     * <p>
     * Converts value into an instance of desiredType. If value is a Byte and
     * not null, and desiredType is Short, Integer, Long, Float, Double,
