...
/**
 * <p>
 * The BigDecimalConverter class handles on demand conversions from the
 * BigDecimal type to various other data types. It implements the
 * OnDemandConverter interface and has no state.
 * </p>
 * <p>
 * When a value is converted by BigDecimalConverter, the condition that the
 * value can be converted is: value is a BigDecimal and is not null, and
 * desiredType is Byte, Short, Integer, Long, Float, Double, or String.
 * </p>
 * <p>
 ...
 * @since 1.1
 */
public class BigDecimalConverter implements OnDemandConverter {

    /**
     * <p>
     * Creates a new BigDecimalConverter.
     * </p>
     */
    ...
    public boolean canConvert(Object value, int column, CustomResultSetMetaData metaData, Class<?> desiredType) {
        ...
        return AbstractionHelper.canConvert(value, BigDecimal.class, desiredType, new Class<?>[] { Byte.class,
            Short.class, Integer.class, Long.class, Float.class, Double.class, String.class });
    }

    /**
     * <p>
     * Converts value into an instance of desiredType. If value is BigDecimal
     * and not null, and desiredType is Byte, Short, Integer, Long, Float,
     * Double and String, value is converted to the corresponding type and
     * returned.
     * </p>
     * <p>
     * <strong>Changes in 2.0:</strong>
