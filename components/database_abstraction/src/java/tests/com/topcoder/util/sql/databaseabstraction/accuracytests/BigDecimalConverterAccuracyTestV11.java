...
/**
 * <p>
 * Accuracy Test cases for the class BigDecimalConverter.
 * </p>
 *
 * @author PE
 * @version 1.1
 */
public class BigDecimalConverterAccuracyTestV11 extends TestCase {
    /** Represents the BigDecimal instance for testing. */
    private static final BigDecimal VALUE = new BigDecimal("1");

    /** Represents the BigDecimalConverter instance for testing. */
