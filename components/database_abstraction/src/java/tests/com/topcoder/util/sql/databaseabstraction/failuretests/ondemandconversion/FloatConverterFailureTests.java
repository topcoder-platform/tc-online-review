...
/**
 * <p>
 * Failure test cases for FloatConverter.
 * </p>
 *
 * @author biotrail
 * @version 1.1
 * @since 1.1
 */
public class FloatConverterFailureTests extends TestCase {
    /**
     * <p>
     * The value object for testing.
     * </p>
     */
    private static final Object VALUE = new Float(42.5);

    /**
     * <p>
     * FloatConverter instance for testing.
     * </p>
     */
    ...
    public static Test suite() {
        return new TestSuite(FloatConverterFailureTests.class);
    }

    /**
     * <p>
     * Tests FloatConverter#convert(Object,int,CustomResultSetMetaData,Class) for failure.
    ...
    /**
     * <p>
     * Tests FloatConverter#canConvert(Object,int,CustomResultSetMetaData,Class) for failure.
     * It tests the case that when column is invalid and expects IllegalArgumentException.
     * </p>
     *
     * @throws Exception to JUnit
