...
/**
 * <p>
 * Failure test cases for TimeConverter.
 * </p>
 *
 * @author biotrail
 * @version 1.1
 * @since 1.1
 */
public class TimeConverterFailureTests extends TestCase {
    /**
     * <p>
     * The value object for testing.
     * </p>
     */
    private static final Object VALUE = new Time(System.currentTimeMillis());

    /**
     * <p>
     * TimeConverter instance for testing.
     * </p>
     */
    ...
    public static Test suite() {
        return new TestSuite(TimeConverterFailureTests.class);
    }

    /**
     * <p>
     * Tests TimeConverter#convert(Object,int,CustomResultSetMetaData,Class) for failure.
    ...
    /**
     * <p>
     * Tests TimeConverter#canConvert(Object,int,CustomResultSetMetaData,Class) for failure.
     * It tests the case that when column is invalid and expects IllegalArgumentException.
     * </p>
     *
     * @throws Exception to JUnit
