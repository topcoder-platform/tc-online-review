...
/**
 * <p>
 * Failure test cases for BlobConverter.
 * </p>
 *
 * @author biotrail
 * @version 1.1
 * @since 1.1
 */
public class BlobConverterFailureTests extends TestCase {
    /**
     * <p>
     * The value object for testing.
     * </p>
     */
    private static final Object VALUE = new DummyBlob();

    /**
     * <p>
     * BlobConverter instance for testing.
     * </p>
     */
    private BlobConverter converter;
    ...
    public static Test suite() {
        return new TestSuite(BlobConverterFailureTests.class);
    }

    /**
     * <p>
     * Tests BlobConverter#convert(Object,int,CustomResultSetMetaData,Class) for failure.
    ...
    /**
     * <p>
     * Tests BlobConverter#canConvert(Object,int,CustomResultSetMetaData,Class) for failure.
     * It tests the case that when column is invalid and expects IllegalArgumentException.
     * </p>
     *
     * @throws Exception to JUnit
