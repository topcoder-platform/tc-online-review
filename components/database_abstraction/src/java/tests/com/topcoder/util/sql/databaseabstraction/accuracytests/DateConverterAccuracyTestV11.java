...
/**
 * <p>
 * Accuracy Test cases for the class DateConverter.
 * </p>
 *
 * @author PE
 * @version 1.1
 */
public class DateConverterAccuracyTestV11 extends TestCase {
    /** Represents the Date instance for testing. */
    private static final Date VALUE = new Date(new java.util.Date().getTime());

    /** Represents the DateConverter instance for testing. */
