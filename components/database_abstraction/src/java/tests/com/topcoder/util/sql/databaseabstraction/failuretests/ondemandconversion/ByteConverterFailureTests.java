...
/**
 * <p>
 * Failure test cases for ByteConverter.
 * </p>
 *
 * @author biotrail
 * @version 1.1
 * @since 1.1
 */
public class ByteConverterFailureTests extends TestCase {
    /**
     * <p>
     * The value object for testing.
     * </p>
     */
    private static final Object VALUE = new Byte((byte) 12);

    /**
     * <p>
     * ByteConverter instance for testing.
     * </p>
     */
    ...
    public static Test suite() {
        return new TestSuite(ByteConverterFailureTests.class);
    }

    /**
     * <p>
     * Tests ByteConverter#convert(Object,int,CustomResultSetMetaData,Class) for failure.
    ...
    /**
     * <p>
     * Tests ByteConverter#canConvert(Object,int,CustomResultSetMetaData,Class) for failure.
     * It tests the case that when column is invalid and expects IllegalArgumentException.
     * </p>
     */
