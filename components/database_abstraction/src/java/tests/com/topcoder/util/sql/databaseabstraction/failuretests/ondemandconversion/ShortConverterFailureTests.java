...
/**
 * <p>
 * Failure test cases for ShortConverter.
 * </p>
 *
 * @author biotrail
 * @version 1.1
 * @since 1.1
 */
public class ShortConverterFailureTests extends TestCase {
    /**
     * <p>
     * The value object for testing.
     * </p>
     */
    private static final Object VALUE = new Short((short) 13);

    /**
     * <p>
     * ShortConverter instance for testing.
     * </p>
     */
    ...
    public static Test suite() {
        return new TestSuite(ShortConverterFailureTests.class);
    }

    /**
     * <p>
     * Tests ShortConverter#convert(Object,int,CustomResultSetMetaData,Class) for failure.
    ...
    /**
     * <p>
     * Tests ShortConverter#canConvert(Object,int,CustomResultSetMetaData,Class) for failure.
     * It tests the case that when column is invalid and expects IllegalArgumentException.
     * </p>
     *
     * @throws Exception to JUnit
