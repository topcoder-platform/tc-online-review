...
/**
 * <p>
 * Accuracy Test cases for the class IntConverter.
 * </p>
 *
 * @author PE
 * @version 1.1
 */
public class IntConverterAccuracyTestV11 extends TestCase {
    /** Represents the Integer instance for testing. */
    private static final Integer VALUE = new Integer("1");

    /** Represents the IntConverter instance for testing. */
    ...
    public void testConvert_Accuracy3() throws Exception {
        ...
        assertEquals("convert is incorrect.", obj, new BigDecimal(VALUE.intValue()));
    }
