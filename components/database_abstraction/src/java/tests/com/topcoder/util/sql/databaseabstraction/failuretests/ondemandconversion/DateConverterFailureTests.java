...
public class DateConverterFailureTests extends TestCase {
     ...
     * </p>
     */
    private static final Object VALUE = new Date(System.currentTimeMillis());

    /**
     * <p>
     * DateConverter instance for testing.
     * </p>
     */
    ...
    /**
     * <p>
     * Tests DateConverter#DateConverter(DateFormat) for failure.
    ...
    /**
     * <p>
     * Tests DateConverter#convert(Object,int,CustomResultSetMetaData,Class) for failure.
    ...
    public void testConvert_UnknownDesiredType() throws Exception {
        try {
            converter.convert(VALUE, 1, FailureHelper.getCustomResultSetMetaDataInstance(), Byte.class);
            fail("IllegalMappingException expected.");
        } catch (IllegalMappingException e) {
            //good
        }
    ...
    /**
     * <p>
     * Tests DateConverter#canConvert(Object,int,CustomResultSetMetaData,Class) for failure.
     * It tests the case that when column is invalid and expects IllegalArgumentException.
     * </p>
     *
     * @throws Exception to JUnit
