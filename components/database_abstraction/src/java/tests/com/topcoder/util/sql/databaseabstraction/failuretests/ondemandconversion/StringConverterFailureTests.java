...
/**
 * <p>
 * Failure test cases for StringConverter.
 * </p>
 *
 * @author biotrail
 * @version 1.1
 * @since 1.1
 */
public class StringConverterFailureTests extends TestCase {
    /**
     * <p>
     * The value object for testing.
     * </p>
     */
    private static final Object VALUE = "98542.55";

    /**
     * <p>
     * StringConverter instance for testing.
     * </p>
     */
    ...
    public static Test suite() {
        return new TestSuite(StringConverterFailureTests.class);
    }

    /**
     * <p>
     * Tests StringConverter#StringConverter(DateFormat) for failure.
     * It tests the case that when dateFormat is null and expects IllegalArgumentException.
     * </p>
     *
     * @throws Exception to JUnit
     */
    public void testCtor_NullDateFormat() throws Exception {
        try {
    ...
    /**
     * <p>
     * Tests StringConverter#convert(Object,int,CustomResultSetMetaData,Class) for failure.
    ...
    public void testConvert_UnknownDesiredType() throws Exception {
        try {
            converter.convert(VALUE, 1, FailureHelper.getCustomResultSetMetaDataInstance(),
                StringConverterFailureTests.class);
            fail("IllegalMappingException expected.");
        } catch (IllegalMappingException e) {
            //good
        }
    ...
    /**
     * <p>
     * Tests StringConverter#canConvert(Object,int,CustomResultSetMetaData,Class) for failure.
     * It tests the case that when column is invalid and expects IllegalArgumentException.
     * </p>
     *
     * @throws Exception to JUnit
