...
/**
 * <p>
 * Failure test cases for BigDecimalConverter.
 * </p>
 *
 * @author biotrail
 * @version 1.1
 * @since 1.1
 */
public class BigDecimalConverterFailureTests extends TestCase {
    /**
     * <p>
     * The value object for testing.
     * </p>
     */
    private static final Object VALUE = new BigDecimal("98542.55");

    /**
     * <p>
     * BigDecimalConverter instance for testing.
     * </p>
     */
    ...
    public static Test suite() {
        return new TestSuite(BigDecimalConverterFailureTests.class);
    }

    /**
     * <p>
     * Tests BigDecimalConverter#convert(Object,int,CustomResultSetMetaData,Class) for failure.
    ...
    /**
     * <p>
     * Tests BigDecimalConverter#canConvert(Object,int,CustomResultSetMetaData,Class) for failure.
     * It tests the case that when column is invalid and expects IllegalArgumentException.
     * </p>
     *
     * @throws Exception to JUnit
