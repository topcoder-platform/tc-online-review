...
/**
 * Provides unit test cases for CompressionException.
 *
 * @author  rem
 * @version 2.0
 * @since   2.0
 */
public class CompressionExceptionTestCase extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(CompressionExceptionTestCase.class);
    }

    /**
     * Tests constructor CompressionException(String message).
     * <ul>
    ...
    public void testConstructor1() {
        CompressionException ex = new CompressionException("message");
    ...
    /**
     * Tests constructor CompressionException(String message, Throwable cause).
     * <ul>
    ...
    public void testConstructor2() {
        ...
        CompressionException ex = new CompressionException("message", cause);
        assertTrue("getMessage() should return message which starts with message given in constructor",
            ex.getMessage().startsWith("message"));
