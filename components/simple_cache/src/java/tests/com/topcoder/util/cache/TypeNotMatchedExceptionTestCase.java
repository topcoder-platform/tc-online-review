...
/**
 * Provides unit test cases for TypeNotMatchedException.
 *
 * @author  rem
 * @version 2.0
 * @since   2.0
 */
public class TypeNotMatchedExceptionTestCase extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(TypeNotMatchedExceptionTestCase.class);
    }

    /**
     * Tests constructor TypeNotMatchedException(String message).
     * <ul>
    ...
    public void testConstructor1() {
        TypeNotMatchedException ex = new TypeNotMatchedException("message");
    ...
    /**
     * Tests constructor TypeNotMatchedException(String message, Throwable cause).
     * <ul>
    ...
    public void testConstructor2() {
        ...
        TypeNotMatchedException ex = new TypeNotMatchedException("message", cause);
        assertTrue("getMessage() should return message which starts with message given in constructor",
            ex.getMessage().startsWith("message"));
