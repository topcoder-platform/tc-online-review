...
public class InformixReviewPersistence implements ReviewPersistence {
     ...
     * @exception ReviewPersistenceException if error occurs when creating IDGenerators.
     */
    public InformixReviewPersistence(String namespace) throws ConfigurationException, ReviewPersistenceException {
     ...
     * @exception ReviewPersistenceException if error occurs when creating IDGenerators.
     */
    public InformixReviewPersistence(DBConnectionFactory dbFactory, String connectionName, SearchBundle searchBundle)
