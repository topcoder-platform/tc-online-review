...
/**
 * <p>
 * Custom security manager that prevents java exit when calling System.exit. It will throw
 * <code>SecurityException</code> instead exiting JVM.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
...
public class NotExitSecurityManager extends SecurityManager {
     ...
     *             always thrown to instead of exiting JVM.
     */
    @Override
