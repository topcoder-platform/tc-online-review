...
class InformixSectionPersistence {
    ...
    public void createSection(Section section, int order, String operator, long parentId)
        ...
        logger.log(Level.DEBUG, new LogMessage("Section", null, operator,
        ...
        try {
        	logger.log(Level.DEBUG, "insert record into scorecard_section with group_id:" + id);
    ...
    void createSections(Section[] sections, String operator, long parentId) throws PersistenceException {
        ...
        try {
            ...
            for (int i = 0; i < sections.length; i++) {
                ...
                logger.log(Level.DEBUG, "insert record into scorecard_section table with groupId:" + ids[i]);
    ...
    public void updateSection(Section section, int order, String operator, long parentId, Scorecard oldScorecard,
        ...
        logger.log(Level.DEBUG, new LogMessage("Section", new Long(section.getId()), operator,
    ...
    public void deleteSections(long[] ids) throws PersistenceException {
        ...
        logger.log(Level.DEBUG, new LogMessage("Section", null, null,
        ...
        try {
            ...
            logger.log(Level.DEBUG, "delete record from scorecard_sections with ids:"
    ...
    public Section getSection(long id) throws PersistenceException {
        ...
        logger.log(Level.DEBUG, new LogMessage("Section", new Long(id), null, "retrieve Section"));
        PreparedStatement pstmt = null;
        ResultSet rs = null;
