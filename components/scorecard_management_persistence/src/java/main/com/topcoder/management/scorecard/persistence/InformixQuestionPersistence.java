...
class InformixQuestionPersistence {
    ...
    public void createQuestion(Question question, int order, String operator, long parentId)
        ...
        logger.log(Level.DEBUG, new LogMessage("Question", null, operator,
        ...
        try {
            logger.log(Level.DEBUG, "insert record into scorecard_question with question id:" + id);
    ...
    void createQuestions(Question[] questions, String operator, long parentId) throws PersistenceException {
        ...
        try {
            ...
            for (int i = 0; i < questions.length; i++) {
                ...
                logger.log(Level.DEBUG, "insert record into scorecard_question with question id:" + ids[i]);
                pstmt.executeUpdate();
            }
    ...
    public void updateQuestion(Question question, int order, String operator, long parentId)
        ...
        logger.log(Level.DEBUG, new LogMessage("Question", new Long(question.getId()), operator,
        		"Update Question with order:" + order + " and parentId:" + parentId));
        
        PreparedStatement pstmt = null;
        try {
        	logger.log(Level.DEBUG, "update record in scorecard_question with question id:" + question.getId());
    ...
    public void deleteQuestions(long[] ids) throws PersistenceException {
        ...
        logger.log(Level.DEBUG, new LogMessage("Question", null, null,
    ...
    public Question getQuestion(long id) throws PersistenceException {
        ...
        logger.log(Level.DEBUG, new LogMessage("Question", new Long(id), null, "retrieve Question"));
