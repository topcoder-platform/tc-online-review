...
/**
 * <p>
 * <code>BaseException</code> is the eventual superclass for any custom
 * exceptions used within TC software components. It provides all the logic of
 * Java 1.4 exceptions (message, stack trace,..).
 * </p>
 * <p>
 * <b>Changes for v2.0: </b> It includes a collection of additional information
 * about the exception, such as module and error codes for identification, a
 * transient logged flag, trigger date/time/thread as well as unlimited
 * key/value pairs.
 * </p>
 * <p>
