...
public final class AccuracyHelper {
    /**
     * <p>
     * Creates a new instance of <code>AccuracyHelper</code> class. The private constructor prevents the
     ...
     * retrieved from the given instance.
     * </p>
     *
     * @param classType the parameter
     ...
     */
    public static Object getPrivateField(Class classType, Object instance, String name) {
        Field field = null;
        Object obj = null;
     ...
     *
     * @throws SQLException if any db operation failed.
     */
    public static void insertIntoComponentVersions(Connection conn) throws SQLException {
        ...
        PreparedStatement psInsert =
            conn.prepareStatement("insert into comp_versions values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    public static void insertIntoComponentCataLog(Connection conn) throws SQLException {
        ...
        Date currentDate = new Date(System.currentTimeMillis());
        PreparedStatement psInsert =
            conn.prepareStatement("insert into comp_catalog values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    public static void insertIntoTechnologyTypes(Connection conn) throws SQLException {
        ...
        psInsert.setString(2, "jdbc"); // Sets technology_name.
        psInsert.setString(3, "java database connection"); // Sets description.
        psInsert.setLong(4, 1); // Sets status_id.
        psInsert.execute();

        // Sets and inserts the second record.
        psInsert.setLong(1, 2); // Sets technology_type_id.
        psInsert.setString(2, "ejb"); // Sets technology_name.
        psInsert.setString(3, "enterprise javabean"); // Sets description.
        psInsert.setLong(4, 1); // Sets status_id.
        psInsert.execute();
        ...
        psInsert.setString(3, "a programming language"); // Sets description.
        psInsert.setLong(4, 1); // Sets status_id.
        psInsert.execute();

        // Sets and inserts the fourth record.
        psInsert.setLong(1, 4); // Sets technology_type_id.
        psInsert.setString(2, "jms"); // Sets technology_name.
        psInsert.setString(3, "java message service"); // Sets description.
        psInsert.setLong(4, 1); // Sets status_id.
        psInsert.execute();
    ...
    /**
     * <p>
     * Inserts into the comp_technology table for testing.
     * </p>
     *
     * @param conn the connection used.
     *
     * @throws SQLException if any db operation failed.
     */
    public static void insertIntoCompTechnology(Connection conn) throws SQLException {

        cleanupTable(conn, "comp_technology");

        // Inserts rows into the table.
        PreparedStatement psInsert = conn.prepareStatement("insert into comp_technology values(?, ?, ?)");

        // Sets and inserts the first record.
        psInsert.setLong(1, 1); // Sets comp_tech_id.
        psInsert.setLong(2, 2); // Sets comp_vers_id.
        psInsert.setLong(3, 1); // Sets technology_type_id.
        psInsert.execute();

        // Sets and inserts the second record.
        psInsert.setLong(1, 2); // Sets comp_tech_id.
        psInsert.setLong(2, 2); // Sets comp_vers_id.
        psInsert.setLong(3, 2); // Sets technology_type_id.
        psInsert.execute();

        // Sets and inserts the third record.
        psInsert.setLong(1, 3); // Sets comp_tech_id.
        psInsert.setLong(2, 4); // Sets comp_vers_id.
        psInsert.setLong(3, 3); // Sets technology_type_id.
        psInsert.execute();

        // Sets and inserts the fourth record.
        psInsert.setLong(1, 4); // Sets comp_tech_id.
        psInsert.setLong(2, 4); // Sets comp_vers_id.
        psInsert.setLong(3, 4); // Sets technology_type_id.
        psInsert.execute();
    ...
    public static void insertIntoEmail(Connection conn) throws SQLException {
        ...
        Date currentDate = new Date(System.currentTimeMillis());
        PreparedStatement psInsert =
            conn.prepareStatement("insert into email values(?, ?, ?, ?, ?, ?, ?, ?)");
        ...
        // Sets and inserts the 1st email information of the 3rd user.
        psInsert.setLong(1, 2004); // Sets user_id.
        psInsert.setLong(2, 2345); // Sets email_id.
        psInsert.setInt(3, 6); // Sets email_type_id.
        psInsert.setString(4, "User4@gmail.com"); // Sets address.
        psInsert.setDate(5, currentDate); // Sets create_date.
        psInsert.setDate(6, currentDate); // Sets modify_date.
        psInsert.setInt(7, 1); // Sets primary_ind.
        psInsert.setInt(8, 8); // Sets status_id.
    ...
    public static void insertIntoUser(Connection conn) throws SQLException {
        ...
        // Sets and inserts the 4nd user.
        psInsert.setLong(1, 2004); // Sets user_id.
        psInsert.setString(2, "First X"); // Sets first_name.
        psInsert.setString(3, "Last X"); // Sets last_name.
        psInsert.setDate(4, currentDate); // Sets create_date.
        psInsert.setDate(5, currentDate); // Sets modify_date.
        psInsert.setString(6, "HaNdle B"); // Sets handle.
        psInsert.setDate(7, currentDate); // Sets last_login.
        psInsert.setString(8, "UnactiveX"); // Sets status.
        psInsert.setString(9, "Psw X"); // Sets password.
        psInsert.setString(10, "Activation Code X");// Sets activation_code.
        psInsert.setString(11, "Middle X"); // Sets middle_name.
        psInsert.setString(12, "handle b"); // Sets handle_lower.
        psInsert.setInt(13, 2); // Sets timezone_id.
        psInsert.execute();
    ...
    public static void insertIntoUserRating(Connection conn) throws SQLException {
        ...
        Date currentDate = new Date(System.currentTimeMillis());
        PreparedStatement psInsert =
            conn.prepareStatement("insert into user_rating values(?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    public static void insertIntoUserReliability(Connection conn) throws SQLException {
        ...
        Date currentDate = new Date(System.currentTimeMillis());
        PreparedStatement psInsert =
            conn.prepareStatement("insert into user_reliability values(?, ?, ?, ?, ?)");
    ...
    /**
     * <p>
     * Asserts the two given object arrays to be equals. The two object arrays will be regarded to be equals
     * only if both the length and the content are equals.
     * </p>
     *
