<%--
  ...
  -
  - Description: This page fragment displays the content of confirming deletion of a submission.
--%>
            ...
            <div id="mainMiddleContent">
                <div style="position: relative; width: 100%;">
                    ...
                    <table class="scorecard" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                        <tr>
                            <td class="title"><or:text key="confirmDeleteSubmission.box.title" /></td>
                        </tr>
                        <tr class="light">
                            <td class="valueC">
                                <br />
                                <or:text key="confirmDeleteSubmission.question" /><br /><br />
                            </td>
                        </tr>
                        <tr>
                    ...
                    <div align="right">
                        <a href="<or:url value='/actions/DeleteSubmission?uid=${uid}&delete=y' />"><img src="<or:text key='confirmDeleteSubmission.btnDelete.img' />" alt="<or:text key='confirmDeleteSubmission.btnDelete.alt' />" border="0" /></a>&#160;
