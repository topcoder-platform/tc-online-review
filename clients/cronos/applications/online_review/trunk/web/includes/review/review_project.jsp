...
<c:if test="${not empty submitterId and reviewType ne 'Screening' and reviewType ne 'Review' and reviewType ne 'Milestone Screening' and reviewType ne 'Milestone Review' and not toPDF}">
