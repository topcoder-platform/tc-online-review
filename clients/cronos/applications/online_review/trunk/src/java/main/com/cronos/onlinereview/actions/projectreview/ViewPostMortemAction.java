...
/**
 * This class is the struts action class which is used to view the post mortem review.
 * <p>
 ...
 * @version 2.0
 */
public class ViewPostMortemAction extends BaseViewOrExportGenericReviewAction {

    /**
     * Represents the serial version id.
     */
    private static final long serialVersionUID = 6365611216183380086L;
    ...
    public String execute() throws BaseException {
        ...
        return viewOrExportGenericReview(request, response, "Post-Mortem", false);
    }
}
