...
tab1off.src = "../i/tab_my_open_projects.gif";
tab1on = new Image(119, 36);
tab1on.src = "../i/tab_my_open_projects_o.gif";

tab2off = new Image(119, 36);
tab2off.src = "../i/tab_all_open_projects.gif";
tab2on = new Image(119, 36);
tab2on.src = "../i/tab_all_open_projects_o.gif";

tab3off = new Image(119, 36);
tab3off.src = "../i/tab_create_project.gif";
tab3on = new Image(119, 36);
tab3on.src = "../i/tab_create_project_o.gif";

tab4off = new Image(119, 36);
tab4off.src = "../i/tab_inactive_projects.gif";
tab4on = new Image(119, 36);
tab4on.src = "../i/tab_inactive_projects_o.gif";
