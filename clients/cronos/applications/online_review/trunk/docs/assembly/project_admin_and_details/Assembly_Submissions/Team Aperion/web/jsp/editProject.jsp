...
<head>
	...
	<!-- TopCoder CSS for Header and Left Navigation -->
	<link type="text/css" rel="stylesheet" href="../css/tcStyles.css">
	<!-- CSS for Online Review -->
	<link type="text/css" rel="stylesheet" href="../css/new_styles.css">
	<!-- JS for Online Top Tab Functionality -->
...
<html:form action="/actions/SaveProject">
	...
	<table class="scorecard" cellpadding="0" width="100%" style="border-collapse: collapse;">
		...
		<td class="value" nowrap><html:text styleClass="inputBox" property="project_name" style="width: 350px" /></td>
        </tr>
        <tr class="dark">
            	<td width="9%" class="valueB"><bean:message key="editProject.ProjectDetails.Type" />
            	</td>
		<td width="91%" class="value" nowrap>
	...
	<tr class="light">
		<td class="valueB"><bean:message key="editProject.ProjectDetails.Category" />
		</td>
	...
	<tr class="dark">
		<td class="valueB"><bean:message key="editProject.ProjectDetails.Eligibility" />
		</td>
		<td class="value" nowrap>
	...
	<tr>
		<td class="valueB"><bean:message key="editProject.ProjectDetails.Public" />
		</td>
		<td class="value" nowrap>
	...
	<tr>
		<td class="title" colspan="2"><bean:message key="editProject.Preferences.title" />
		</td>
	</tr>
	<tr class="light">
		<td class="valueB" width="1%"><bean:message key="editProject.Preferences.Autopilot" /><br></td>
		<td class="value">
			<html:radio property="autopilot" value="true" /><b> <bean:message key="editProject.Preferences.Autopilot.Completion" /> </b>
				<bean:message key="editProject.Preferences.Autopilot.Completion.Desc" /> <br>
			<html:radio property="autopilot" value="false" /><b> <bean:message key="editProject.Preferences.Autopilot.TurnOff" /></b>
		</td>
        </tr>
	<tr class="dark">
	...
	<tr class="light">
		<td class="valueB"><bean:message key="editProject.Scorecards.Screening" />
		</td>
		<td class="value" nowrap>
			<html:select styleClass="inputBox" property="scorecard_screening" style="width:350px">
				<option selected>Select</option>
				<option>Component Design Screening Scorecard v1.0</option>
			</html:select>
		</td>
        </tr>
	<tr class="dark">
		<td class="valueB"><bean:message key="editProject.Scorecards.Review" />
		</td>
		<td class="value" nowrap>
			<html:select styleClass="inputBox" property="scorecard_review" style="width:350px;">
				<option>Select</option>
				<option>Component Design Review Scorecard v1.4.2</option>
			</html:select>
		</td>
        </tr>
	<tr class="light">
		<td class="valueB" nowrap><bean:message key="editProject.Scorecards.Approval" />
		</td>
		<td class="value" nowrap>
	...
	<table class="scorecard" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse">
		<tr>
        	<td class="title"><b>Create Timeline</b></td>
			<td class="title">
			&nbsp;</td>
		</tr>
		<tr class="light">
			<td class="value" width="2%" nowrap><b>Use Timeline Template:</b></td>
			<td class="value">
	...
	<table class="scorecard" id="timeline_tbl" cellpadding="0" width="100%" style="border-collapse: collapse;">
		<tr>
			<td class="header"><b><bean:message key="editProject.Phases.PhaseName" /></b></td>
            		<td class="header"><b><bean:message key="editProject.Phases.PhaseStart" /></b></td>
            		<td class="header"><b><bean:message key="editProject.Phases.PhaseEnd" /></b></td>
            		<td class="header" nowrap><b><bean:message key="editProject.Phases.Duration" /></b></td>
            		<td class="header"><b><bean:message key="editProject.Phases.Delete" /></b></td>
		</tr>
		
		<%-- The following three rows are used as a "template" for the newly added project phases --%>		
		<tr class="dark" style="display: none;" >
			<td class="valueB" nowrap></td>
			<td class="value" nowrap>
				...
				<bean:message key="editProject.Phases.EST" />
				<br>
	...
	<table class="scorecard" id="addphase_tbl">
		...
		<!-- BEGIN ADD PHASE FORM -->

		<tr class="light">
            		<td class="value" nowrap colspan="2">
				...
				<br><bean:message key="editProject.Phases.Placement" /> 
				...
				</html:select>&nbsp;<html:select styleClass="inputBox" property="addphase_where">
			        	<html:option key="editProject.Phases.SelectPhase" value="" />					
				</html:select>
			</td>
			<td class="value" nowrap width="37%">
				...
				<html:select styleClass="inputBox" property="addphase_start_dayshrs">
            		...
            		<td class="value" nowrap width="18%">
				...
				<bean:message key="editProject.Phases.EST" />			
            		...
            		<td class="value" nowrap width="6%" colspan="2">
	...
	<tr>
        	<td class="title" colspan="5"><bean:message key="editProject.Resources.title"/>
        	</td>
	</tr>
	<tr>
		<td class="header"><b><bean:message key="editProject.Resources.Role"/></b>
		</td>
            	<td class="header"><b><bean:message key="editProject.Resources.Name"/></b>
            	</td>
            	<td class="header"><b><bean:message key="editProject.Resources.Payment"/></b>
            	</td>
            	<td class="header"><b><bean:message key="editProject.Resources.Paid"/></b>
            	</td>
		<td class="headerC">&nbsp;
		</td>
	</tr>
	<tr class="light">
		<td class="value" nowrap>
			<html:select styleClass="inputBox" property="resources_role" value="-1" style="width:150px;">
            	...
            	<td class="value" nowrap>
			<html:checkbox property="resources_payment" /><bean:message key="editProject.Resources.Payment.dollar" /> 
			...
			<html:select styleClass="inputBox" property="resources_paid" style="width:120px">
				...
				<html:option key="editProject.Resources.Paid.Select" value="" />
				<html:option key="editProject.Resources.Paid.NA" value="N/A" />
				<html:option key="editProject.Resources.Paid.Not Paid" value="false" />
				<html:option key="editProject.Resources.Paid.Paid" value="true" />
			</html:select>
		</td>
	...
	<html:image src="../i/bttn_save.gif" styleClass="bttnBottom" />
	<img src="../i/bttn_cancel.gif" class="bttnBottom" name="cancel" id="cancel"><br>
	<br>
	<br>
</html:form>
</div>
