...
--       but about all submissions, uploads, resources, notifications and
--       phases as well.  You'll need to repopulate the databse with that
--       information using appropritate scripts.
