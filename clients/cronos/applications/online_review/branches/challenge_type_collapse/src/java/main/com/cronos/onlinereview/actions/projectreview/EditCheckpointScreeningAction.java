...
/**
 * This class is the struts action class which is used to edit the checkpoint screening.
 * <p>
 ...
 * @version 2.0
 */
public class EditCheckpointScreeningAction extends BaseProjectReviewAction {
    ...
    public String execute() throws BaseException {
        ...
        return editGenericReview(request, "Checkpoint Screening");
    }
}
