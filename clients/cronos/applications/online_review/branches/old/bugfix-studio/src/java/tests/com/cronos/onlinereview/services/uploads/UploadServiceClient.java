...
public class UploadServiceClient {
     ...
     */
    private final static String END_POINT = "http://63.118.154.172/review/services/UploadService";
    ...
    public long uploadSubmission(long projectId, long ownerId, String filename) throws ServiceException,
        ...
        // call.
        return ((Number) call.invoke(new Object[] {new Long(projectId), new Long(ownerId), new File(filename).getName(), dhSource})).longValue();
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            long ret = client.uploadSubmission(38101194, 154896, "c:/sub-test.txt");
            System.out.println("Submission ID: " + ret);
        } catch (Exception e) {
            e.printStackTrace();
        } 
    }
