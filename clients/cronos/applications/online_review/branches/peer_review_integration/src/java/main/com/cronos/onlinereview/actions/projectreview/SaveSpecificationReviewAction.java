...
/**
 * This class is the struts action class which is used to save the specification review.
 * <p>
 ...
 * @version 2.0
 */
public class SaveSpecificationReviewAction extends BaseProjectReviewAction {

    /**
     * Represents the serial version id.
     */
    private static final long serialVersionUID = -5705844898022997966L;
    ...
    public String execute() throws BaseException {
        ...
        return saveGenericReview(getModel(), request, "Specification Review");
    }
}
