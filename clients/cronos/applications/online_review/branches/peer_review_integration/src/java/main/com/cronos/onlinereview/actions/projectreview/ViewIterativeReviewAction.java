...
/**
 * This class is the struts action class which is used to view the iterative review.
 * <p>
 ...
 * @version 2.0
 */
public class ViewIterativeReviewAction extends BaseViewOrExportGenericReviewAction {

    /**
     * Represents the serial version id.
     */
    private static final long serialVersionUID = -2743054488894056763L;
    ...
    public String execute() throws BaseException {
        ...
        return viewOrExportGenericReview(request, response, "Iterative Review", false);
    }
}
