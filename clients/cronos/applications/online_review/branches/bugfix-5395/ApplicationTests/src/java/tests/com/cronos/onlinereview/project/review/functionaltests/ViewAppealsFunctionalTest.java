...
/**
 * <p>A test case for <code>View Appeals</code> Use Case.</p>
 *
 * @author  TCSDEVELOPER
 * @version 1.0
 */
public class ViewAppealsFunctionalTest extends AbstractTestCase {
        ...
        for (int i = 0; i < SUBMISSION_IDS.length; i++) {
            ...
            for (int j = 0; j < unauthorizedUsers.length; j++) {
                ...
                for (int k = 0; k < REVIEWERS.length; k++) {
                    ...
                    assertDisplayedMessage(Messages.getNoPermissionViewAppeals());
                }
            }
        }
    }
     ...
     * <p>Scenario #117</p>
     * <pre>
     * Note: User has permission to view appeals
     * 1.  User clicks on "All Open Projects" tab
     * 2.  User views project list and selects a project
     * 3.  User clicks on "Review/Appeals" tab
     * 4.  User selects a submission and clicks on "Appeal"
     ...
     * <p> <b>Expected Outcome:</b><br/>
     *
     * Scorecard Review with Appeals is displayed. </p>
     */
    public void testScenario117() throws Exception {
