...
/**
 * This class is the struts action class which is used to save the approval.
 * <p>
 ...
 * @version 2.0
 */
public class SaveApprovalAction extends BaseProjectReviewAction {

    /**
     * Represents the serial version id.
     */
    private static final long serialVersionUID = -8122560280881896152L;
    ...
    public String execute()
        ...
        return saveGenericReview(getModel(), request, "Approval");
    }
}
