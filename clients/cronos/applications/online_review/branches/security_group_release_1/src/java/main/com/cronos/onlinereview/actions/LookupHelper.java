...
class LookupHelper {
     ...
     */
    static ScorecardType getScorecardType(String entityName) throws LookupException {
        // Validate parameters
     ...
     */
    static ScorecardType getScorecardType(long entityID) throws LookupException {
        // Validate parameters
     ...
     *             if the entity with the given name could not be found.
     */
    static CommentType getCommentType(String entityName) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterStringNotEmpty(entityName, "typeName");
     ...
     *             if the entity with the given ID could not be found.
     */
    static CommentType getCommentType(long entityID) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterPositive(entityID, "typeId");
     ...
     *             if the entity with the given name could not be found.
     */
    static ProjectCategory getProjectCategory(String entityName) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterStringNotEmpty(entityName, "typeName");
     ...
     *             if the entity with the given ID could not be found.
     */
    static ProjectCategory getProjectCategory(long entityID) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterPositive(entityID, "typeId");
     ...
     *             if the entity with the given name could not be found.
     */
    static ProjectStatus getProjectStatus(String entityName) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterStringNotEmpty(entityName, "typeName");
     ...
     *             if the entity with the given ID could not be found.
     */
    static ProjectStatus getProjectStatus(long entityID) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterPositive(entityID, "typeId");
     ...
     *             if the entity with the given name could not be found.
     */
    static ResourceRole getResourceRole(String entityName) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterStringNotEmpty(entityName, "typeName");
     ...
     *             if the entity with the given ID could not be found.
     */
    static ResourceRole getResourceRole(long entityID) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterPositive(entityID, "typeId");
     ...
     *             if the entity with the given name could not be found.
     */
    static PhaseType getPhaseType(String entityName) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterStringNotEmpty(entityName, "typeName");
     ...
     *             if the entity with the given ID could not be found.
     */
    static PhaseType getPhaseType(long entityID) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterPositive(entityID, "typeId");
     ...
     *             if the entity with the given name could not be found.
     */
    static PhaseStatus getPhaseStatus(String entityName) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterStringNotEmpty(entityName, "typeName");
     ...
     *             if the entity with the given ID could not be found.
     */
    static PhaseStatus getPhaseStatus(long entityID) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterPositive(entityID, "typeId");
     ...
     *             if the entity with the given name could not be found.
     */
    static SubmissionStatus getSubmissionStatus(String entityName) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterStringNotEmpty(entityName, "typeName");
     ...
     *             if the entity with the given ID could not be found.
     */
    static SubmissionStatus getSubmissionStatus(long entityID) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterPositive(entityID, "typeId");
     ...
     *             if the entity with the given name could not be found.
     */
    static SubmissionType getSubmissionType(String entityName) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterStringNotEmpty(entityName, "typeName");
     ...
     *             if the entity with the given ID could not be found.
     */
    static SubmissionType getSubmissionType(long entityID) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterPositive(entityID, "typeId");
     ...
     *             if the entity with the given name could not be found.
     */
    static UploadStatus getUploadStatus(String entityName) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterStringNotEmpty(entityName, "typeName");
     ...
     *             if the entity with the given ID could not be found.
     */
    static UploadStatus getUploadStatus(long entityID) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterPositive(entityID, "typeId");
     ...
     *             if the entity with the given name could not be found.
     */
    static UploadType getUploadType(String entityName) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterStringNotEmpty(entityName, "typeName");
     ...
     *             if the entity with the given ID could not be found.
     */
    static UploadType getUploadType(long entityID) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterPositive(entityID, "typeId");
     ...
     *             if the entity with the given name could not be found.
     */
    static PrizeType getPrizeType(String entityName) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterStringNotEmpty(entityName, "typeName");
     ...
     *             if the entity with the given ID could not be found.
     */
    static PrizeType getPrizeType(long entityID) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterPositive(entityID, "typeId");
     ...
     *             if the entity with the given name could not be found.
     */
    static NotificationType getNotificationType(String entityName) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterStringNotEmpty(entityName, "typeName");
     ...
     *             if the entity with the given ID could not be found.
     */
    static NotificationType getNotificationType(long entityID) throws LookupException {
        // Validate parameters
        ActionsHelper.validateParameterPositive(entityID, "typeId");
